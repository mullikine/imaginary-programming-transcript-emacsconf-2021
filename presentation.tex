...
\label{sec:org6f95173}
\begin{frame}[label={sec:org5436056},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org7ed29be}
\begin{frame}[label={sec:org20db9ef},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org1a098de}
\begin{frame}[label={sec:orgf6d3289}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3e47a8d}
\begin{frame}[label={sec:orgfad5015},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgdc4e69f}
\begin{frame}[label={sec:org1682a4a},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0771c17}
\begin{frame}[label={sec:orgbfe1a83},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgb8a45ed}
\begin{frame}[label={sec:orgd8b61cc}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org009ae76}
\begin{frame}[label={sec:org8481654}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5d0f4c3}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2c2f0aa},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1be61e5}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge715d70}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org30967d3}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6ceb15a}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0254216},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orga189771}
\begin{frame}[label={sec:org894366f},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org605a05c}
\begin{frame}[label={sec:orge279fc1},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgfc2f0f6}
\begin{frame}[label={sec:org344c361}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org82463e1}
\begin{frame}[label={sec:orgdbe1f57},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org52b81df}
\begin{frame}[label={sec:org48e299b},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9efcbe3},fragile]{\texttt{imacro}}
 {\tiny
