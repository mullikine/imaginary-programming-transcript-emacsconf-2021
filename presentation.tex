...
\label{sec:orgef4a6d9}
\begin{frame}[label={sec:org9796aaf}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org3775ab5}
\begin{frame}[label={sec:org65f37cd},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org2ff63cb}
\begin{frame}[label={sec:org998f736}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgfa352f8}
\begin{frame}[label={sec:orga3af99b},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orga0f7a55}
\begin{frame}[label={sec:org32479df},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgbfb2b6b}
\begin{frame}[label={sec:orgbe124ce},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org80b7bf9}
\begin{frame}[label={sec:org5deaf0e}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgec2ea94}
\begin{frame}[label={sec:orgdf6716e}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2764a63}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcebba60},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
 \begin{block}{more emacs}
\begin{itemize}
...
\item \href{https://mullikine.github.io/posts/imaginary-equivalence-needs-blockchain/}{Imaginary equivalence testing}
...
\begin{frame}[label={sec:orgd2f1fad}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcd70544}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6667a1f}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org94a0d38}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0f2c930}]{Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgfd564a6}
\begin{frame}[label={sec:org6287135}]{Freedom (EmacsConf 2021)}
...
\item they can see anything public (they are license-blinded. GPL-4 may neo be enough),
...
\label{sec:orgb5702c5}
\begin{frame}[label={sec:org20389ae},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org89f861e}
\begin{frame}[label={sec:orgde4ed15}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org9199b63}
\begin{frame}[label={sec:org3af81b7},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org45b1202}
\begin{frame}[label={sec:org68ea9cf},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orgdf003fb}
\subsection{Pen.el v2}
\label{sec:org95d6308}
\begin{verbatim}
 1  phenomenology
