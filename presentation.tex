...
\label{sec:orgecc8862}
\begin{frame}[label={sec:org10fe421}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org60eafd1}
\begin{frame}[label={sec:orgfd2ac15},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org6170ea5}
\begin{frame}[label={sec:org98f9dfc}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8f70618}
\begin{frame}[label={sec:orgaf0c69a},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3524f66}
\begin{frame}[label={sec:org3439a14},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgc2b2160}
\begin{frame}[label={sec:orgaf8596e},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org28a6cd1}
\begin{frame}[label={sec:org6404828}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgb42071f}
\begin{frame}[label={sec:org8dd9486}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6ca25bd}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org95266e3},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgefeddc4}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgae82f85}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9d39bc9}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org459a1bd}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org13904b8},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org3c20d21}
\begin{frame}[label={sec:orgc9125cc},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org398b9c3}
\begin{frame}[label={sec:org5e8ab80},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgdc7eed3}
\begin{frame}[label={sec:org38353e9}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgedd99bd}
\begin{frame}[label={sec:org51c17d1},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgf807306}
\begin{frame}[label={sec:org0d3b18e},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org44d7933},fragile]{\texttt{imacro}}
...
\label{sec:orgf23ab7b}
\subsection{Pen.el v2}
\label{sec:orgc68a895}
\begin{verbatim}
 1  phenomenology
