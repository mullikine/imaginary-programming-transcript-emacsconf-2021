...
\label{sec:orgcbf2938}
\begin{frame}[label={sec:orgfcce221},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgf165adf}
\begin{frame}[label={sec:org6a3b246},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org7212f48}
\begin{frame}[label={sec:org74fe76a}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org169d98c}
\begin{frame}[label={sec:orgee09679},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgaf5f94b}
\begin{frame}[label={sec:orgc81ac47},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgfd3a40d}
\begin{frame}[label={sec:orgc48409d},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org70b6182}
\begin{frame}[label={sec:orgf6ed827}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgd2e878a}
\begin{frame}[label={sec:org9f81e13}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0079eb6}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1f89abe},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org869e968}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb86f212}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5f1a7bb}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgaea377b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8f86227},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org80c14bc}
\begin{frame}[label={sec:orgf3ff5a6},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org863157c}
\begin{frame}[label={sec:org7179f37},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd9c537f}
\begin{frame}[label={sec:orgca2d148}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org327a99a}
\begin{frame}[label={sec:orge51158d},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgd5a56ff}
\begin{frame}[label={sec:org437ddb4},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org6d1e605}
\begin{frame}[label={sec:org2b12554},fragile]{ilambda.el (EmacsConf 2021)}
