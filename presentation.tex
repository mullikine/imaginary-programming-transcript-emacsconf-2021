...
\label{sec:orgc12eee2}
\begin{frame}[label={sec:org14dd99b}]{Following along}
...
\label{sec:org3f862c5}
\begin{frame}[label={sec:org44f1873},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org742487e}
\begin{frame}[label={sec:orgeb0d557}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org0ad6c44}
\begin{frame}[label={sec:orgdf1367a},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org1cdf4ad}
\begin{frame}[label={sec:orgccfd509},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org7213046}
\begin{frame}[label={sec:org709867a},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org00a3e02}
\begin{frame}[label={sec:org7e42adb}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org54c3779}
\begin{frame}[label={sec:org7550037}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org3f89fc7}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgcbf82ed},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org690e4b4}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org928e0da}]{Philosophy}
...
\begin{frame}[label={sec:org28e7c45}]{Philosophy}
...
\begin{frame}[label={sec:org2eb8c45}]{Philosophy}
...
\begin{frame}[label={sec:org9bae76e}]{Philosophy}
...
\section{Freedom}
\label{sec:org618aeff}
\begin{frame}[label={sec:org77bb702}]{Freedom}
{\tiny
...
\label{sec:org0d350a2}
\begin{frame}[label={sec:org2253110},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:org01ae7c3}
\begin{frame}[label={sec:org48ac1bd}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgb8afe06}
\begin{frame}[label={sec:org8dd33d0},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org092ce42}
\begin{frame}[label={sec:org1f05d11},fragile]{ilambda.el}
