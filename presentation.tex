...
\label{sec:orgb27dc1f}
\begin{frame}[label={sec:orgf87552c}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc0a3a78}
\begin{frame}[label={sec:orgecf9294},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgd576775}
\begin{frame}[label={sec:org6a08a59}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org616b822}
\begin{frame}[label={sec:org73dc052},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5dd9a66}
\begin{frame}[label={sec:org1ca28c8},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org7a8ff15}
\begin{frame}[label={sec:orgbaea5ca},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org2612d47}
\begin{frame}[label={sec:orgbbb09c4}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org388038b}
\begin{frame}[label={sec:org0d6d190}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5983e64}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga9f2423},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1cbd8bc}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd2ca93f}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org21f591e}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd872de6}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org59fe328},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
The \texttt{ilambda.el} primitives are \texttt{ieval}, \texttt{imacro} and \texttt{idefun}. The currently only a language model as a
parameter, but in future this will be an \texttt{sNFT}.
\end{block}
\end{frame}

\section{Freedom}
\label{sec:orgc67eda2}
\begin{frame}[label={sec:org8fcdbfc},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgac3ed06}
\begin{frame}[label={sec:orge838e1d},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org090bc77}
\begin{frame}[label={sec:orgda30bf9}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org708768e}
\begin{frame}[label={sec:orgd8d6d74},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org08a1644}
\begin{frame}[label={sec:orgb3afc46},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7e7e411},fragile]{\texttt{imacro}}
...
\label{sec:org554d27d}
\subsection{Pen.el v2}
\label{sec:org755745e}
\begin{verbatim}
 1  phenomenology
