...
\label{sec:org9db597d}
\begin{frame}[label={sec:orgea69872}]{Following along}
...
\label{sec:org090f906}
\begin{frame}[label={sec:org163debe},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgaa41c81}
\begin{frame}[label={sec:org1057c21}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org58c3082}
\begin{frame}[label={sec:org09d7a5b},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org6f6e402}
\begin{frame}[label={sec:orgb30bbf3},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgf721970}
\begin{frame}[label={sec:orgd97c630},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgd4893d1}
\begin{frame}[label={sec:orgab5b7be}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgd91ab7c}
\begin{frame}[label={sec:org49b6970}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org682c34d}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga8aff7c}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgc74a163}]{Philosophy}
...
\begin{frame}[label={sec:org360bfb4}]{Philosophy}
...
\begin{frame}[label={sec:org1f1bc9f}]{Philosophy}
...
\begin{frame}[label={sec:orgaceb716}]{Philosophy}
...
\section{Freedom}
\label{sec:org64b10fd}
\begin{frame}[label={sec:org837cb6d}]{Freedom}
...
\label{sec:org638b8f6}
\begin{frame}[label={sec:orgabb56cb},fragile]{Imaginary Programming}
...
\label{sec:org1d19be5}
\subsection{Using \texttt{pen.el}}
\label{sec:org86994d4}
\begin{frame}[label={sec:org5aa7c73},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org8ed67c7}
\begin{frame}[label={sec:org0647035},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgb3bb794}
\begin{frame}[label={sec:orgb08104c},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org8a762ac},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org09f7f0c},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgdf74ba6},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org14dca35}
\subsection{\texttt{pen.el}}
\label{sec:org7d2491e}
\begin{frame}[label={sec:org5c2a4c5},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgb41c3bd}
\begin{frame}[label={sec:org30b158c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgbb28ed1},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org3f72c53}
\begin{frame}[label={sec:orgafc7358}]{Something funny}
...
\begin{frame}[label={sec:org7c83df2}]{Something funny}
...
\begin{frame}[label={sec:orgfde4526}]{Create a prompt}
...
\section{Appendix}
\label{sec:org889b18a}
\subsection{Additional reading}
\label{sec:orgb6405d5}
\begin{frame}[label={sec:orge81aba3}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
