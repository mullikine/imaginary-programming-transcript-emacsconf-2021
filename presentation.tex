...
\label{sec:orgc0ee4b5}
\begin{frame}[label={sec:orga77b285}]{Following along}
...
\label{sec:org6ace625}
\begin{frame}[label={sec:orgfb09da2},fragile]{Imaginary Programming (emacsconf 2021)}
...
\label{sec:orgc775e0f}
\begin{frame}[label={sec:org8f89419}]{AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orgb7b95eb}
\begin{frame}[label={sec:orge4a8359}]{Emacs as the command-center for prompting}
...
\section{Imaginary Computing}
\label{sec:orgc002c1d}
\begin{frame}[label={sec:org6aa2728},fragile]{Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgc2bf086}
\begin{frame}[label={sec:org6156a05},fragile]{Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org3ab6e15}
\begin{frame}[label={sec:orgc7ff5c6},fragile]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org7c6a8a6}]{Paracosm vs Metaverse}
...
\label{sec:orgb7d877e}
\subsection{GPT-3}
\label{sec:orga8a6ccb}
\begin{frame}[label={sec:orgf5bcf26},fragile]{Text Generator}
...
\label{sec:orgc91f62e}
\begin{frame}[label={sec:orgd538dbe},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgd64dea4},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgf7a29d9}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org756070b}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org8670b63}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org014dc37},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgaaa2f26},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org2f64e15},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org18df0da},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8ad6591},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org7d11451}]{Techniques}
...
\label{sec:org9b02467}
\subsection{Using \texttt{pen.el}}
\label{sec:orgb170fc8}
\begin{frame}[label={sec:orgb2d7438},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org583ce7d}
\begin{frame}[label={sec:orgae25d0e},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orge8beb7d}
\begin{frame}[label={sec:orgdc09b16},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgfc3060e},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgdc898f1},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgcec9935},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org2bdf608}
\subsection{\texttt{pen.el}}
\label{sec:org88af0b6}
\begin{frame}[label={sec:orgd040203},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgcd8f8cb}
\begin{frame}[label={sec:orgca7bbb9},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org0f3f7f0},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org6101757}
\begin{frame}[label={sec:orgd2d0964}]{Something funny}
...
\begin{frame}[label={sec:orge149e66}]{Something funny}
...
\begin{frame}[label={sec:orgf72cf84}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgc183db9}
\subsection{Additional reading}
\label{sec:orgfc1af1f}
\begin{frame}[label={sec:org021cad4}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
