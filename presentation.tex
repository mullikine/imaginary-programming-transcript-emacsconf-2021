...
\label{sec:orgde54aa6}
\begin{frame}[label={sec:org002ee15}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge5d83b1}
\begin{frame}[label={sec:org2b8b3dc},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgdebd252}
\begin{frame}[label={sec:org02e813e}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org38e6697}
\begin{frame}[label={sec:org34dceb2},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga0db23d},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8c76402}
\begin{frame}[label={sec:org9bc17a7},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgc71bfb4}
\begin{frame}[label={sec:orgc16e4cb}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5b0b7f9}
\begin{frame}[label={sec:org912402b}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge19db22}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgeadcaba},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org781a08b}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5d135f7}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org72093fe}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfcf5df1}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org156c506}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orga50dfa9}
\begin{frame}[label={sec:org36c719d},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org1432895}
\begin{frame}[label={sec:org57a933f},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org27cd2dd}
\begin{frame}[label={sec:org9b7f770}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgea2146e}
\begin{frame}[label={sec:org4bfd328},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org9566b35}
\begin{frame}[label={sec:orga814b3c},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org407fbc8},fragile]{\texttt{imacro}}
...
\label{sec:orgecdbb69}
\subsection{Pen.el v2}
\label{sec:orge6326d7}
\begin{verbatim}
 1  phenomenology
