...
\label{sec:org68d80ba}
\begin{frame}[label={sec:orgbb7c502}]{Following along}
...
\label{sec:org3c5520c}
\begin{frame}[label={sec:orgdf99bcf},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgda82d60}
\begin{frame}[label={sec:org326baf1}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org2ade166}
\begin{frame}[label={sec:orgd2a032c},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org6f5d55f}
\begin{frame}[label={sec:org3ba280b},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org765f896}
\begin{frame}[label={sec:orgc8e17a4},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org962af93}
\begin{frame}[label={sec:orgafdc035}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org23718ed}
\begin{frame}[label={sec:org69eff48}]{Imaginary Computing: Paracosm vs Metaverse}
\begin{block}{Imaginary Web}
The imaginary web is:
\begin{itemize}
\item an analog of the World-Wide-Web imagined by a LM.
\end{itemize}
...
\begin{frame}[label={sec:org8094bd4}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2ea44c8}]{Philosophy}
...
\begin{frame}[label={sec:orgcae0afc}]{Philosophy}
...
\begin{frame}[label={sec:orgc7e086c}]{Philosophy}
...
\begin{frame}[label={sec:orgc69ba15}]{Philosophy}
...
\label{sec:orgd05f939}
\subsection{GPT-3}
\label{sec:orgcbb4606}
\begin{frame}[label={sec:org0f082fe},fragile]{Text Generator}
...
\label{sec:orgfc46147}
\begin{frame}[label={sec:orgdd0341b},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org87f0bea},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org4783681}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgbfca058}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org8d78b1f}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org4986b16},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgbf654b9},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org716f423},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org3e1dca9},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5975e2f},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgdb487a4}]{Techniques}
...
\label{sec:org29b3fc0}
\subsection{Using \texttt{pen.el}}
\label{sec:org6e3325d}
\begin{frame}[label={sec:orgb3d2d69},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgb6aa89e}
\begin{frame}[label={sec:org4f60aae},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org0002d92}
\begin{frame}[label={sec:org1eee356},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org88471de},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgd928160},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org401459e},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org426b811}
\subsection{\texttt{pen.el}}
\label{sec:org25ea4e7}
\begin{frame}[label={sec:org4fe5fb4},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgf3ce99e}
\begin{frame}[label={sec:org9700c84},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org56efd87},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org7ece101}
\begin{frame}[label={sec:org92b3a36}]{Something funny}
...
\begin{frame}[label={sec:orgf170dcf}]{Something funny}
...
\begin{frame}[label={sec:org3578c27}]{Create a prompt}
...
\section{Appendix}
\label{sec:org1a99993}
\subsection{Additional reading}
\label{sec:orgd674a7d}
\begin{frame}[label={sec:org792624a}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
