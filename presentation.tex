...
\label{sec:org78cfac6}
\begin{frame}[label={sec:org5b1b6ff}]{Following along}
...
\label{sec:org49c55f5}
\begin{frame}[label={sec:org41359ce},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org080d8c1}
\begin{frame}[label={sec:orgbe19ea5}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org06048b2}
\begin{frame}[label={sec:orgd60124f},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org6b5f63c}
\begin{frame}[label={sec:orga41e5ad},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgbf03923}
\begin{frame}[label={sec:org994179c},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org659f49c}
\begin{frame}[label={sec:org8468709}]{Imaginary Computing: Potential Dystopia}
\begin{block}{Meta-tasks and microtasks}
\begin{itemize}
...
\section{Imaginary Computing}
\label{sec:org880f1be}
\begin{frame}[label={sec:org42e5acd},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga2ad5c6}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1b8dd5d}]{Philosophy}
...
\begin{frame}[label={sec:org9635e32}]{Philosophy}
...
\begin{frame}[label={sec:orgfa274dd}]{Philosophy}
...
\begin{frame}[label={sec:org1a8cc48}]{Philosophy}
...
\label{sec:orgac50dd4}
\subsection{GPT-3}
\label{sec:org4f9c2c9}
\begin{frame}[label={sec:org1e5b45e},fragile]{Text Generator}
...
\label{sec:org5728d4c}
\begin{frame}[label={sec:orga22defb},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org7caabca},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org3e727f2}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3dd93ca}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orge065988}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgb6a2b3f},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgd447a1b},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgd8f4be1},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgc121011},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgf3e8e29},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org316f996}]{Techniques}
...
\label{sec:org33e3e79}
\subsection{Using \texttt{pen.el}}
\label{sec:org4e7908d}
\begin{frame}[label={sec:org8a051d9},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org40ee01f}
\begin{frame}[label={sec:orge27808f},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orge09e166}
\begin{frame}[label={sec:orgf8a9bff},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org41ec760},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org6936411},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orge2194bd},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org7d0ed96}
\subsection{\texttt{pen.el}}
\label{sec:orga271034}
\begin{frame}[label={sec:org5f02347},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org0d01138}
\begin{frame}[label={sec:org08d7a37},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org76a3854},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orge79b5b4}
\begin{frame}[label={sec:org3aeb33f}]{Something funny}
...
\begin{frame}[label={sec:org315a0bf}]{Something funny}
...
\begin{frame}[label={sec:orge4e6f51}]{Create a prompt}
...
\section{Appendix}
\label{sec:org7fa209c}
\subsection{Additional reading}
\label{sec:org4ce5d92}
\begin{frame}[label={sec:orge2f0715}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
