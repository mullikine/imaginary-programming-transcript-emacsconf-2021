...
\label{sec:org675e81c}
\begin{frame}[label={sec:orgb618261}]{Following along}
...
\label{sec:org1394ea8}
\begin{frame}[label={sec:org828cccf},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org6fd6d38}
\begin{frame}[label={sec:org26e9210}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org11f6c04}
\begin{frame}[label={sec:org7fe07e6},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org995a5a2}
\begin{frame}[label={sec:orgb2d1387},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org888223f}
\begin{frame}[label={sec:org2924ddc},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org908d23d}
\begin{frame}[label={sec:org12b62d3}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgba5aac2}
\begin{frame}[label={sec:org1016576}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga14b198}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2077ce1}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org48da009}]{Philosophy}
...
\begin{frame}[label={sec:orge9b1c37}]{Philosophy}
...
\begin{frame}[label={sec:org52d766d}]{Philosophy}
...
\begin{frame}[label={sec:org92a43d0}]{Philosophy}
...
\section{Freedom}
\label{sec:org828159d}
\begin{frame}[label={sec:orgd67620d}]{Freedom}
...
\label{sec:orgf5f648b}
\begin{frame}[label={sec:org763b948},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orge190f09}
\begin{frame}[label={sec:org762a3d1}]{Blockchain and a Language model is all you need}
