...
\label{sec:org7369a06}
\begin{frame}[label={sec:orgd651602}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org4fb104f}
\begin{frame}[label={sec:org09c1371},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org8cfaff8}
\begin{frame}[label={sec:org50a2588}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgfcdd440}
\begin{frame}[label={sec:org16870ef},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org47be33e}
\begin{frame}[label={sec:orgdffb85e},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9c5fa8c}
\begin{frame}[label={sec:org3d233ce},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org31fa7d5}
\begin{frame}[label={sec:org6037987}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org6e268f3}
\begin{frame}[label={sec:org5b16a8e}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf73521b}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfbe5142},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb978526}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2fc9774}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1a1d0f9}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgacf3704}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org54d8ac0}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgc720540}
\begin{frame}[label={sec:org9be6620},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org034969a}
\begin{frame}[label={sec:org3a2eb98},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd96d026}
\begin{frame}[label={sec:orgf7cabac}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgddbc9df}
\begin{frame}[label={sec:orgb4e1f8f},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orga60ca77}
\begin{frame}[label={sec:org5a0991c},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orga71e549}
\subsection{Pen.el v2}
\label{sec:orga1c575a}
\begin{verbatim}
 1  phenomenology
