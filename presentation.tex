...
\label{sec:org5e88393}
\begin{frame}[label={sec:org41c268e}]{Following along}
...
\label{sec:org3888135}
\begin{frame}[label={sec:org36f0874},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:org1ec902b}
\begin{frame}[label={sec:orge7d58e7}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org8e23cb3}
\begin{frame}[label={sec:org1e29be9},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orged7ce67}
\begin{frame}[label={sec:orgc6b07e7},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgd141b94}
\begin{frame}[label={sec:org1a11aa2},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org56839cf}
\begin{frame}[label={sec:orgafde921},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgd9ca790}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orge55a6f3}]{Philosophy}
...
\begin{frame}[label={sec:orgf9005d5}]{Philosophy}
...
\begin{frame}[label={sec:orgc880a65}]{Philosophy}
...
\begin{frame}[label={sec:orgeba0f05}]{Philosophy}
...
\label{sec:org5e08e7d}
\subsection{GPT-3}
\label{sec:org2a5443b}
\begin{frame}[label={sec:org25c3fe3},fragile]{Text Generator}
...
\label{sec:org84380a7}
\begin{frame}[label={sec:org30e20db},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgcff2981},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orga548ca8}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org695767a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgc960bed}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7d09926},fragile]{Design patterns}
...
\begin{frame}[label={sec:org92681d5},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org7830f9e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgbdf2f7b},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org2011f65},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgdb64ac4}]{Techniques}
...
\label{sec:org39d9d34}
\subsection{Using \texttt{pen.el}}
\label{sec:orgfe2131b}
\begin{frame}[label={sec:orgb357dff},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org3c50359}
\begin{frame}[label={sec:org2ca618f},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org888ce88}
\begin{frame}[label={sec:org5c60aa6},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgec92659},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org539c221},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org7c09f47},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgc6f3ced}
\subsection{\texttt{pen.el}}
\label{sec:orgca0e55c}
\begin{frame}[label={sec:org4125af5},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org74137f8}
\begin{frame}[label={sec:org78c976f},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org71d87ce},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgb9f8287}
\begin{frame}[label={sec:orgcfc9c89}]{Something funny}
...
\begin{frame}[label={sec:orgddca754}]{Something funny}
...
\begin{frame}[label={sec:orga59c0ef}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgd95df41}
\subsection{Additional reading}
\label{sec:orgd47f1dc}
\begin{frame}[label={sec:org5c708df}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
