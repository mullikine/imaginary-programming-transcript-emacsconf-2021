...
\label{sec:org494c2bd}
\begin{frame}[label={sec:orgf83231b}]{Following along}
...
\label{sec:org7360f03}
\begin{frame}[label={sec:org151cb59},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org5f52954}
\begin{frame}[label={sec:org82e7978}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org9ac1319}
\begin{frame}[label={sec:orgd98d4e7},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org0b231b6}
\begin{frame}[label={sec:org546da8f},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org1b1fe3d}
\begin{frame}[label={sec:org50e7710},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org09af28f}
\begin{frame}[label={sec:org79e8371}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org733cc94}
\begin{frame}[label={sec:orga80f5e9}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org38da150}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga6f8a7c},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgecde242}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgd20395c}]{Philosophy}
...
\begin{frame}[label={sec:org118c84b}]{Philosophy}
...
\begin{frame}[label={sec:orgb4d1aa2}]{Philosophy}
...
\begin{frame}[label={sec:org6973d19}]{Philosophy}
...
\section{Freedom}
\label{sec:orgdeeb3e5}
\begin{frame}[label={sec:org61f04a9}]{Freedom}
...
\label{sec:org0b55059}
\begin{frame}[label={sec:orgef2cbcd},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgcd1b060}
\begin{frame}[label={sec:org4b55932}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgd913621}
\begin{frame}[label={sec:org04a445e},fragile]{𝑖λ (ilambda.el)}
 \begin{block}{Code}
An \texttt{IP} library named \texttt{𝑖λ.el} for emacs.
...
\section{ilambda}
\label{sec:orga0329eb}
\begin{frame}[label={sec:org5a1ae7b},fragile]{𝑖λ (ilambda.el)}
