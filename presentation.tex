...
\label{sec:org674f479}
\begin{frame}[label={sec:orgef35e5d}]{Following along}
...
\label{sec:orgab9dc65}
\subsection{emacsconf 2021}
\label{sec:org7974a97}
LMs are our best friends in the AI model
menagerie because they make things
intelligible -- by understanding our textual
languages.

\begin{frame}[label={sec:orga3edf6d},fragile]{Objectives}
 \begin{itemize}
...
\label{sec:org06879fb}
\subsection{GPT-3}
\label{sec:orgbe721e8}
\begin{frame}[label={sec:org9ec50ed},fragile]{Text Generator}
...
\label{sec:org9262c3d}
\begin{frame}[label={sec:orgb2b91db},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org17e95e6},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org028c96a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgadfbf4c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org33a5ca6}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgdbdc16b},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgac6b812},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org1526f18},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orge60609b},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4de7e1e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5cda7c9}]{Techniques}
...
\label{sec:org726eedc}
\subsection{Using \texttt{pen.el}}
\label{sec:orgec3d8cc}
\begin{frame}[label={sec:org14364d0},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgfc92bf1}
\begin{frame}[label={sec:orgc861337},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org4f20055}
\begin{frame}[label={sec:org3883ec9},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org4034457},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org3c16259},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org99c14fd},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org7b25297}
\subsection{\texttt{pen.el}}
\label{sec:orgd9bd7e2}
\begin{frame}[label={sec:orgfb9be77},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org3efc4fe}
\begin{frame}[label={sec:org23a769c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org464fd83},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgc01ca83}
\begin{frame}[label={sec:org0511bfc}]{Something funny}
...
\begin{frame}[label={sec:orgd6b1e15}]{Something funny}
...
\begin{frame}[label={sec:org4907ab6}]{Create a prompt}
...
\section{Appendix}
\label{sec:org0df02f4}
\subsection{Additional reading}
\label{sec:org41c3333}
\begin{frame}[label={sec:org836f7ae}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
