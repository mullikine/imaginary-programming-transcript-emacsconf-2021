...
\label{sec:org006e572}
\begin{frame}[label={sec:org23d6e77}]{Following along}
...
\section{Imaginary Computing}
\label{sec:org575c5e4}
\begin{frame}[label={sec:org39ad8e8},fragile]{Intelligent NFTs (blockchain)}
...
\section{Imaginary Computing}
\label{sec:org4023f63}
\begin{block}{A bleak future}
\begin{itemize}
...
\begin{frame}[label={sec:org351815b}]{Paracosm vs Metaverse}
\begin{itemize}
\item Paracosm
\begin{itemize}
\item Privacy
...
\label{sec:org8e20653}
\subsection{GPT-3}
\label{sec:orgda33d95}
\begin{frame}[label={sec:orgdb5ce61},fragile]{Text Generator}
...
\label{sec:orgf010dbb}
\begin{frame}[label={sec:orgd1c422c},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgd76351e},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org8434c50}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgeae082c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgf990920}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org5837fae},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgd945fa1},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgefbed87},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org214fe2c},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org0e7edc8},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org749e971}]{Techniques}
...
\label{sec:org751e614}
\subsection{Using \texttt{pen.el}}
\label{sec:orgcb5de67}
\begin{frame}[label={sec:orgdcd5f7e},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org8ef592c}
\begin{frame}[label={sec:org01d9993},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orge03053b}
\begin{frame}[label={sec:orgceee306},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgfda51b2},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgfbeb73a},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orge3a0d8e},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgd9efd14}
\subsection{\texttt{pen.el}}
\label{sec:org335c919}
\begin{frame}[label={sec:org48e5c4a},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org9def056}
\begin{frame}[label={sec:orgdba5304},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org35b39b6},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgbdcfbfa}
\begin{frame}[label={sec:org6b942ef}]{Something funny}
...
\begin{frame}[label={sec:orgee5aef7}]{Something funny}
...
\begin{frame}[label={sec:org8ff2c53}]{Create a prompt}
...
\section{Appendix}
\label{sec:org5e1a997}
\subsection{Additional reading}
\label{sec:org6ff4b0a}
\begin{frame}[label={sec:org1e66d67}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
