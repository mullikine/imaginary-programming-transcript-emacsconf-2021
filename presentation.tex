...
\label{sec:org1b6f866}
\begin{frame}[label={sec:orgf191f24},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org8183c3a}
\begin{frame}[label={sec:orgbfbbb61},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org4c92bb2}
\begin{frame}[label={sec:org00731cc}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orge9e9db6}
\begin{frame}[label={sec:org519c8be},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org122a19d}
\begin{frame}[label={sec:orgc7a410e},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org71f38f7}
\begin{frame}[label={sec:org3ef4d69},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org48e7404}
\begin{frame}[label={sec:org7604dc5}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgfba698b}
\begin{frame}[label={sec:org7677b8a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org747826a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd56c3aa},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0add6db}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc63e5b8}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8074eab}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5d7e095}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org08e56e8},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orge87de4c}
\begin{frame}[label={sec:org22dc2a7},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgb4dace1}
\begin{frame}[label={sec:org2c8fa07},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgf537eb5}
\begin{frame}[label={sec:orgf95f743}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org83af8d5}
\begin{frame}[label={sec:orge1fca67},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgd26be7e}
\begin{frame}[label={sec:orgcb5e2c4},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgc54a36a}
\begin{frame}[label={sec:org4142278},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orge327920}
\begin{frame}[label={sec:org76e1efd},fragile]{ilambda.el (EmacsConf 2021)}
