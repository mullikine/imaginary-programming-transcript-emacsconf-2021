...
\label{sec:orgf50fb08}
\begin{frame}[label={sec:org0a53a7c},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgf3a7069}
\begin{frame}[label={sec:org86799a1},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org24ee195}
\begin{frame}[label={sec:orga6ec0be}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org592e6b1}
\begin{frame}[label={sec:org4e6bdf8},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org7447bf6}
\begin{frame}[label={sec:org36158ba},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgcc4a88c}
\begin{frame}[label={sec:orgb6312c9},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org04377d1}
\begin{frame}[label={sec:org38260ca}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org461f202}
\begin{frame}[label={sec:org9870426}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4bed56f}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2ca8f41},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9d7eed3}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org57a0cec}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6520b3b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc6f99bc}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb50d1fd},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org6938df3}
\begin{frame}[label={sec:org8e3cf28},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org903c194}
\begin{frame}[label={sec:orga594a7f},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org32e735e}
\begin{frame}[label={sec:org7d217f5}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgc4eb991}
\begin{frame}[label={sec:org814eb64},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgedd3c39}
\begin{frame}[label={sec:org4922931},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgc92a5a8}
\begin{frame}[label={sec:org5201413},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org7384850}
\begin{frame}[label={sec:orgd0d1453},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org753057a}
\begin{frame}[label={sec:org1cfae7b},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org6ab54b0}
\begin{frame}[label={sec:orga88a671},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgbfe22f9}
\begin{frame}[label={sec:orgadd2e4d},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org514fc39}
\begin{frame}[label={sec:org1b09eae},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgb6bb132}
\begin{frame}[label={sec:org5ce21b2},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org48bfa48}
\begin{frame}[label={sec:org2f99568},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{\texttt{imacro} generates code}
{\tiny
Macro expand.
}
...
\section{In closing}
\label{sec:org4552cd7}
\begin{frame}[label={sec:orgad03deb}]{ilambda.el (EmacsConf 2021)}
