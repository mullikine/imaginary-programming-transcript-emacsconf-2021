...
\label{sec:org04c1a97}
\begin{frame}[label={sec:orge6aa1ec},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org468da6f}
\begin{frame}[label={sec:org77d81b9},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org4b53517}
\begin{frame}[label={sec:org1cf25d6}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org190eead}
\begin{frame}[label={sec:orge11764d},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgdf12556}
\begin{frame}[label={sec:org3f2d573},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org89e5678}
\begin{frame}[label={sec:org2f287af},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org96ddca8}
\begin{frame}[label={sec:org88264a7}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgaaf4034}
\begin{frame}[label={sec:orgdbbe4e7}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1fce533}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8a3103f},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9394419}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2b7353f}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org3704580}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org22832bd}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org3983283},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org8ad09cc}
\begin{frame}[label={sec:orgb8271bc},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org1d10973}
\begin{frame}[label={sec:org7dacba6},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org6599f58}
\begin{frame}[label={sec:org738ef12}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org77f1488}
\begin{frame}[label={sec:orgcc35540},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org2d2ff20}
\begin{frame}[label={sec:org5a6f642},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb26263e},fragile]{\texttt{imacro}}
 {\tiny
