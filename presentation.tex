...
\label{sec:org42a9e6b}
\begin{frame}[label={sec:org429d9bb},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org1082397}
\begin{frame}[label={sec:orgab01881},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgb20b906}
\begin{frame}[label={sec:org179b128}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgc1b3767}
\begin{frame}[label={sec:orgbc451ae},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org84f6e15}
\begin{frame}[label={sec:orgf4d0c79},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1fae4de}
\begin{frame}[label={sec:org442b05c},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgdfc1ce4}
\begin{frame}[label={sec:orgf449abc}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf7cad50}
\begin{frame}[label={sec:orgb7fd9cf}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge1d81ce}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf8d0514},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org32be5fd}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org870d3e0}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2a491b4}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5ffbec1}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7f4633e},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org50b5eec}
\begin{frame}[label={sec:org5a0401e},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org7227e78}
\begin{frame}[label={sec:org85cfa70},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org58f9c77}
\begin{frame}[label={sec:orga1fe644}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orge152517}
\begin{frame}[label={sec:orgcf9cd46},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org5033ebe}
\begin{frame}[label={sec:orgc6ef5ff},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgffae052},fragile]{\texttt{imacro}}
...
\label{sec:orgd836a33}
\subsection{Pen.el v2}
\label{sec:org9689e32}
\begin{verbatim}
 1  phenomenology
