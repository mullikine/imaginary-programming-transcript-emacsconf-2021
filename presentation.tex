...
\label{sec:orga785348}
\begin{frame}[label={sec:org4413936}]{Following along}
...
\label{sec:org508446d}
\begin{frame}[label={sec:org6417ac0},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org4898f38}
\begin{frame}[label={sec:orgcffb3b1}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org0cd2a4d}
\begin{frame}[label={sec:org221b362},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org18ef84f}
\begin{frame}[label={sec:orgf9e7d81},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org00b982d}
\begin{frame}[label={sec:org1a33747},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org9029e53}
\begin{frame}[label={sec:orgead084d}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org864cb75}
\begin{frame}[label={sec:org7578730}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2200038}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1947e19}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga97beb7}]{Philosophy}
...
\begin{frame}[label={sec:orgf7ad983}]{Philosophy}
...
\begin{frame}[label={sec:orgf19e5ed}]{Philosophy}
...
\begin{frame}[label={sec:org680dceb}]{Philosophy}
...
\section{Freedom}
\label{sec:orgef86ef2}
\begin{frame}[label={sec:orga5e3d80}]{Freedom}
...
\label{sec:org50659e1}
\begin{frame}[label={sec:org60121df},fragile]{Imaginary Programming}
...
\label{sec:org4d0997b}
\subsection{Using \texttt{pen.el}}
\label{sec:org2a90e9b}
\begin{frame}[label={sec:orgafa0fa9},fragile]{\texttt{pen.el}}
...
\section{Blockchain and a language model is all you need}
\label{sec:org1fc2349}
\begin{frame}[label={sec:orgad974e0}]{Blockchain and a Language model is all you need}
