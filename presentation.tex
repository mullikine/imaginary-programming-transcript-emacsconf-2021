...
\label{sec:org350eab8}
\begin{frame}[label={sec:org42116ce}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org3ac294e}
\begin{frame}[label={sec:org28e760c},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org479e886}
\begin{frame}[label={sec:org1bf16dd}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5dbaa85}
\begin{frame}[label={sec:org499c5b1},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf7936cd}
\begin{frame}[label={sec:org32f4289},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org975b37a}
\begin{frame}[label={sec:orge97c518},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org7f9ee48}
\begin{frame}[label={sec:org758f3df}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4aa50bc}
\begin{frame}[label={sec:orgbfbd3f2}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0f84ada}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8384804},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org269ab33}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge66ff1e}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7dd6f62}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7d23950}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org38a3bfd}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgcfbe8b0}
\begin{frame}[label={sec:org697d977},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org09f1bcc}
\begin{frame}[label={sec:org6f2ee5d},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org0760b41}
\begin{frame}[label={sec:orgb734c33}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgd2139fe}
\begin{frame}[label={sec:org9407771},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org2f0ef54}
\begin{frame}[label={sec:org63df1a8},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4552318},fragile]{\texttt{imacro}}
...
\label{sec:org1187483}
\subsection{Pen.el v2}
\label{sec:org53c81cc}
\begin{verbatim}
 1  phenomenology
