...
\label{sec:org737adda}
\begin{frame}[label={sec:org3098324}]{Following along}
...
\label{sec:org629100a}
\begin{frame}[label={sec:org7cda072},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgba031b0}
\begin{frame}[label={sec:org9446afa}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org01220ba}
\begin{frame}[label={sec:org7b7ffa7},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org950cfed}
\begin{frame}[label={sec:org5201d57},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgc5a9e6c}
\begin{frame}[label={sec:org2f2f9a9},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org43f6e64}
\begin{frame}[label={sec:org508867d}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgf1a0054}
\begin{frame}[label={sec:orgebaf4ea}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org84696da}]{Imaginary Computing: Paracosm vs Metaverse}
\begin{block}{emacs}
\begin{description}
...
\begin{frame}[label={sec:orgd694c4c}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org841eb8e}]{Philosophy}
...
\begin{frame}[label={sec:org68ee12c}]{Philosophy}
...
\begin{frame}[label={sec:orged58416}]{Philosophy}
...
\begin{frame}[label={sec:orgd37588f}]{Philosophy}
...
\label{sec:org2bc7f20}
\subsection{GPT-3}
\label{sec:org9cbc008}
\begin{frame}[label={sec:orgf6c7874},fragile]{Text Generator}
...
\label{sec:orgd34ce20}
\begin{frame}[label={sec:org0abca6b},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org5b5b827},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgcd1a705}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgebb6615}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org05b7ced}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgba0e753},fragile]{Design patterns}
...
\begin{frame}[label={sec:org866388e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org38a24e2},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org322e348},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8304b47},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org43047c0}]{Techniques}
...
\label{sec:orgc83ee51}
\subsection{Using \texttt{pen.el}}
\label{sec:orgc740ae8}
\begin{frame}[label={sec:org9545d35},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orga22d4ae}
\begin{frame}[label={sec:org54b38bf},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgc39e121}
\begin{frame}[label={sec:orga81f3f9},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgf91e5a0},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org7a9bab0},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org36ab459},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orga5603ab}
\subsection{\texttt{pen.el}}
\label{sec:orgf5ddd85}
\begin{frame}[label={sec:org47b7f71},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgc1c6082}
\begin{frame}[label={sec:orgf68a926},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org6f950ec},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org50a0b6e}
\begin{frame}[label={sec:org4408d0f}]{Something funny}
...
\begin{frame}[label={sec:org4e58f2d}]{Something funny}
...
\begin{frame}[label={sec:org0ab5b2f}]{Create a prompt}
...
\section{Appendix}
\label{sec:org7baac7a}
\subsection{Additional reading}
\label{sec:org1e50a84}
\begin{frame}[label={sec:orga4b1829}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
