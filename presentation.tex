...
\label{sec:orgccdf4d3}
\begin{frame}[label={sec:org6b2ed67}]{Following along}
...
\label{sec:org24508b9}
\begin{frame}[label={sec:org4c84346},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orga6e5aff}
\begin{frame}[label={sec:org3e22595}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orge956fb7}
\begin{frame}[label={sec:org54268aa},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org2818d7f}
\begin{frame}[label={sec:org55c3a46},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org0d7ab3e}
\begin{frame}[label={sec:org2617f68},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgdf525ef}
\begin{frame}[label={sec:org06e395a}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org366fb78}
\begin{frame}[label={sec:org27f6cc7}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org15d770b}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org25a8ac2}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8255f61}]{Philosophy}
...
\begin{frame}[label={sec:org78f0049}]{Philosophy}
...
\begin{frame}[label={sec:orgcf647f3}]{Philosophy}
...
\begin{frame}[label={sec:org5c755cd}]{Philosophy}
...
\label{sec:org58f02f7}
\subsection{GPT-3}
\label{sec:org2bf4818}
\begin{frame}[label={sec:orgc86cabf},fragile]{Text Generator}
...
\label{sec:org2b2dc10}
\begin{frame}[label={sec:orge7bf574},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org524800c},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org9323937}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgd965a53}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgbdf03d9}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgec22ccd},fragile]{Design patterns}
...
\begin{frame}[label={sec:org08d3d9f},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org993fc56},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org766a17a},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org3fd0a72},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org34b14e0}]{Techniques}
...
\label{sec:org5417a8c}
\subsection{Using \texttt{pen.el}}
\label{sec:orgaa156cf}
\begin{frame}[label={sec:orgc532bd3},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org11b28c7}
\begin{frame}[label={sec:org9ce8f21},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org65e2218}
\begin{frame}[label={sec:orga9a5167},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org54d97a5},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org1ff6242},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org6dd31ef},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org16a5b42}
\subsection{\texttt{pen.el}}
\label{sec:org81fea35}
\begin{frame}[label={sec:org4424813},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgd86a4a6}
\begin{frame}[label={sec:org2b273e4},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org256a6b3},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgfe0e8f0}
\begin{frame}[label={sec:orga28e700}]{Something funny}
...
\begin{frame}[label={sec:org8822a54}]{Something funny}
...
\begin{frame}[label={sec:orgef56eae}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgd561985}
\subsection{Additional reading}
\label{sec:org771a9b1}
\begin{frame}[label={sec:orge9fe6ea}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
