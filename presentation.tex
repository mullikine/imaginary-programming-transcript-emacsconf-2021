...
\label{sec:org8eb6c2d}
\begin{frame}[label={sec:orge5936de}]{Following along}
...
\label{sec:orgf7e897a}
\begin{frame}[label={sec:orgeff43b0},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org752f8cd}
\begin{frame}[label={sec:orgd607299}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org7272f14}
\begin{frame}[label={sec:orgf105ca9},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org49d3e01}
\begin{frame}[label={sec:org5941b80},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgd468f4e}
\begin{frame}[label={sec:org3851bda},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orge187822}
\begin{frame}[label={sec:orgdf156db}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org1aec4ad}
\begin{frame}[label={sec:orgd4ca488}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org6c481bc}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org5501860},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1cf0661}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org6cced8f}]{Philosophy}
...
\begin{frame}[label={sec:org2749583}]{Philosophy}
...
\begin{frame}[label={sec:org95b6c79}]{Philosophy}
...
\begin{frame}[label={sec:org7bb3bac}]{Philosophy}
...
\section{Freedom}
\label{sec:org693464c}
\begin{frame}[label={sec:orgea63f5f}]{Freedom}
...
The problem, with LMs: they are so large and
hidden behind SAAS, they can see anything
public (they are license-blinded).
\end{block}
...
\label{sec:org242704c}
\begin{frame}[label={sec:org2a1dee4},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgac524a8}
\begin{frame}[label={sec:orgf95630e}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org412006a}
\begin{frame}[label={sec:org0274561},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orga57f7cc}
\begin{frame}[label={sec:orgc382f2f},fragile]{ilambda.el}
