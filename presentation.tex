...
\label{sec:org4473ba3}
\begin{frame}[label={sec:org286c350}]{Following along}
...
\label{sec:org132b89c}
\begin{frame}[label={sec:orgb07ff0e},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge3eddba}
\begin{frame}[label={sec:org3d5ec90}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org127cb84}
\begin{frame}[label={sec:orge26c98b},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org4bd376c}
\begin{frame}[label={sec:org9d925df},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgbad59c3}
\begin{frame}[label={sec:orgdd7b9ef},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org82fad0a}
\begin{frame}[label={sec:org0dd92e0}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org32e640a}
\begin{frame}[label={sec:orgc20d662}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org846e0d6}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org3df93b7}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org0f2a3ee}]{Philosophy}
...
\begin{frame}[label={sec:org22ce6a6}]{Philosophy}
...
\begin{frame}[label={sec:orgc43a423}]{Philosophy}
...
\begin{frame}[label={sec:org6f93126}]{Philosophy}
...
\section{Freedom}
\label{sec:orgbdc2e50}
\begin{frame}[label={sec:org225bd5f}]{Freedom}
...
\label{sec:orgb631e38}
\begin{frame}[label={sec:org431fe83},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:org06e3e08}
\begin{frame}[label={sec:orgacdaf45}]{Blockchain and a Language model is all you need}
