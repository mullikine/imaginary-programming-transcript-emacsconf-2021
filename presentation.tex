...
\label{sec:org99056da}
\begin{frame}[label={sec:org9a78e2b}]{Following along}
...
\label{sec:org2c052d9}
\begin{frame}[label={sec:org641e550},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org737d02b}
\begin{frame}[label={sec:org21013f8}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org06b75bd}
\begin{frame}[label={sec:orgf972ffd},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org8285011}
\begin{frame}[label={sec:orgdf5ab91},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orga889ab0}
\begin{frame}[label={sec:orgdccccb8},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org62f18ee}
\begin{frame}[label={sec:org8a28b42}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org416f45f}
\begin{frame}[label={sec:orga1c4202}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga03f2d4}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1e035d1}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org766d69f}]{Philosophy}
...
\begin{frame}[label={sec:org590048b}]{Philosophy}
...
\begin{frame}[label={sec:org7510359}]{Philosophy}
...
\begin{frame}[label={sec:orgfd3a006}]{Philosophy}
...
\section{Freedom}
\label{sec:org2844029}
\begin{frame}[label={sec:org45d0825}]{Freedom}
...
\label{sec:org00f27b7}
\begin{frame}[label={sec:org9f89b41},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgbe825a2}
\begin{frame}[label={sec:orgd9be475}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org350904c}
\begin{frame}[label={sec:orga36c794},fragile]{𝑖λ (ilambda.el)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org1131d87}
\begin{frame}[label={sec:org4dff075},fragile]{𝑖λ (ilambda.el)}
