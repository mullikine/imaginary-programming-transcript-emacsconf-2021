...
\label{sec:org0ca9df2}
\begin{frame}[label={sec:orgce4db21}]{Following along}
...
\label{sec:org69a7922}
\begin{frame}[label={sec:orgd587adc},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org47c1942}
\begin{frame}[label={sec:org09cf858}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org8ef46f4}
\begin{frame}[label={sec:org1d5ccff},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgc5826ed}
\begin{frame}[label={sec:org3142943},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org1e6016f}
\begin{frame}[label={sec:org3acc147},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org1663aaf}
\begin{frame}[label={sec:orgbbc3ebb}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgea50198}
\begin{frame}[label={sec:orgc4b64de}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org31f63e8}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org92bb16f},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org4a23f20}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org4c3093b}]{Philosophy}
...
\begin{frame}[label={sec:org3aa830c}]{Philosophy}
...
\begin{frame}[label={sec:org2165847}]{Philosophy}
...
\begin{frame}[label={sec:org58be26c}]{Philosophy}
...
\section{Freedom}
\label{sec:org8a20b7e}
\begin{frame}[label={sec:org7af925b}]{Freedom}
...
\label{sec:org73b1c29}
\begin{frame}[label={sec:org5a155ed},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:org9cabb6c}
\begin{frame}[label={sec:org117199b}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org60a65d0}
\begin{frame}[label={sec:orgea75c50},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org6fa656b}
\begin{frame}[label={sec:orgb676cb4},fragile]{ilambda.el}
