...
\label{sec:org5f012fb}
\begin{frame}[label={sec:org021f774}]{Following along}
...
\label{sec:org25e819c}
\begin{frame}[label={sec:orgc29ed9b},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orga2a3ff9}
\begin{frame}[label={sec:org8ee7fda}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org60bea6c}
\begin{frame}[label={sec:orga91cf4e},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org72967e4}
\begin{frame}[label={sec:org16c9d0a},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org3eaf8e7}
\begin{frame}[label={sec:orgd47076f},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgefcc268}
\begin{frame}[label={sec:orge101334}]{Imaginary Computing: Potential Dystopia}
...
Decentralise microtasks.

\url{https://en.wikipedia.org/wiki/The\_Tower\_of\_Babel\_(Bruegel)}
\end{block}
\end{frame}

\section{Imaginary Computing}
\label{sec:org53dfb73}
\begin{frame}[label={sec:org0544094},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org26a7b6a}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgc5b7075}]{Philosophy}
...
\begin{frame}[label={sec:org9e97f15}]{Philosophy}
...
\begin{frame}[label={sec:org90fbd24}]{Philosophy}
...
\begin{frame}[label={sec:org4618a64}]{Philosophy}
...
\label{sec:orgf188f9b}
\subsection{GPT-3}
\label{sec:orgdda5a6f}
\begin{frame}[label={sec:org95d0571},fragile]{Text Generator}
...
\label{sec:orgeb98a5f}
\begin{frame}[label={sec:orgd5c82e3},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgfe5883c},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org2c8e2f8}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgd3ddf8e}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org9ca077a}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7b9a30e},fragile]{Design patterns}
...
\begin{frame}[label={sec:org2bdc156},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org43a40dd},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orga9d84ac},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4a6de0e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6019ffd}]{Techniques}
...
\label{sec:org7f7beb6}
\subsection{Using \texttt{pen.el}}
\label{sec:orgdb6954a}
\begin{frame}[label={sec:org64753ce},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org3794e39}
\begin{frame}[label={sec:org4452334},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org2d7d257}
\begin{frame}[label={sec:orgb3bc3d7},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orge368ee2},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org3effe25},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org3bfdffe},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org0f62e6b}
\subsection{\texttt{pen.el}}
\label{sec:org0054e27}
\begin{frame}[label={sec:orgfa62c31},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgbaf248c}
\begin{frame}[label={sec:orgd77cb5c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgf77bbdd},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org60e0754}
\begin{frame}[label={sec:orgef0fd81}]{Something funny}
...
\begin{frame}[label={sec:orgd1bfb15}]{Something funny}
...
\begin{frame}[label={sec:org5c7123c}]{Create a prompt}
...
\section{Appendix}
\label{sec:org6d65606}
\subsection{Additional reading}
\label{sec:org2d19af1}
\begin{frame}[label={sec:org43d3c5f}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
