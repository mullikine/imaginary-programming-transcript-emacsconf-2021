...
\label{sec:orgba4566a}
\begin{frame}[label={sec:orgedf2b36}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc7af50b}
\begin{frame}[label={sec:org2ac0758},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgb62da08}
\begin{frame}[label={sec:org6d74f82}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org71ff6a6}
\begin{frame}[label={sec:orgb64a59f},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orge9fb3b5}
\begin{frame}[label={sec:orge1a4cfb},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4c8dc09}
\begin{frame}[label={sec:org544fb71},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org63d973f}
\begin{frame}[label={sec:orgb5a4c96}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org46e8ecb}
\begin{frame}[label={sec:org8380033}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org39df9c9}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2d980e0},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9f834d9}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgac57bba}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgce068a1}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6e10717}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgeb175c0}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org7294290}
\begin{frame}[label={sec:orgdb0edca},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org7901a91}
\begin{frame}[label={sec:org82cb74f},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org91b65ce}
\begin{frame}[label={sec:org1b76d7e}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgc637820}
\begin{frame}[label={sec:org7701a2e},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org6c3382e}
\begin{frame}[label={sec:org4c553af},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgdb8aea3},fragile]{\texttt{imacro}}
...
\label{sec:orgff77241}
\subsection{Pen.el v2}
\label{sec:orgc464884}
\begin{verbatim}
 1  phenomenology
