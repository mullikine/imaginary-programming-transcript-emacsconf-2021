...
\label{sec:orgb4efd2b}
\begin{frame}[label={sec:org485f026}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc990c1a}
\begin{frame}[label={sec:org4e02729},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org64907c6}
\begin{frame}[label={sec:org96b6037}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgbb78cd8}
\begin{frame}[label={sec:org0929dba},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgaca0648}
\begin{frame}[label={sec:orgca2a735},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgea827cd}
\begin{frame}[label={sec:orga80083f},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf09df6f}
\begin{frame}[label={sec:org02f3e00}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8f47568}
\begin{frame}[label={sec:org004d4ed}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0c03699}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1164947},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org537a10d}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga819f98}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1df90f0}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb874219}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org13a6c1c}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org8cb05c1}
\begin{frame}[label={sec:orgcfef2c7},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\item they can see anything public (they are license-blinded. A GNU Public License v4 is not enough\ldots{}),
...
\label{sec:org81315f0}
\begin{frame}[label={sec:orgf251ca2},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org76aab52}
\begin{frame}[label={sec:org9c553ec}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgde0c105}
\begin{frame}[label={sec:org161473e},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org7637e1c}
\begin{frame}[label={sec:orga7427be},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orga3a9be3}
\subsection{Pen.el v2}
\label{sec:org71ba4f6}
\begin{verbatim}
 1  phenomenology
