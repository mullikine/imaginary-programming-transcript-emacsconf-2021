...
\label{sec:orga20b19b}
\begin{frame}[label={sec:org19d33de}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org588b9ae}
\begin{frame}[label={sec:orga78872e},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org483a204}
\begin{frame}[label={sec:orgfba8bc2}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3c1ba79}
\begin{frame}[label={sec:org35d0786},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org2076045}
\begin{frame}[label={sec:org1fdea88},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf355ea8}
\begin{frame}[label={sec:org06b43fc},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8a1bd5e}
\begin{frame}[label={sec:org0ec7a4f}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgd62bc67}
\begin{frame}[label={sec:org8eaa8da}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgdba8b4a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge14ce0a},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org30fab7d}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org83000fc}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org01044a2}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd89ce4b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgddbed7a}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org4d1a9a7}
\begin{frame}[label={sec:org819eea2},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org72f850e}
\begin{frame}[label={sec:org65453d9},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org9ae30c4}
\begin{frame}[label={sec:orgbdc326d}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orga5ae9d0}
\begin{frame}[label={sec:org6bebe48},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org1ae0a93}
\begin{frame}[label={sec:org64d70c9},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9e27199},fragile]{\texttt{imacro}}
...
\label{sec:org4b19257}
\subsection{Pen.el v2}
\label{sec:orge256b18}
\begin{verbatim}
 1  phenomenology
