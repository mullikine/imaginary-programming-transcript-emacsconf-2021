...
\label{sec:org291b8de}
\begin{frame}[label={sec:org002d39d}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org585486e}
\begin{frame}[label={sec:org5748235},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge4cb3b4}
\begin{frame}[label={sec:orgf92b26d}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orge38a081}
\begin{frame}[label={sec:orgb6c5133},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgc64acf3}
\begin{frame}[label={sec:org4f79662},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org89a556b}
\begin{frame}[label={sec:org4142040},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org126effb}
\begin{frame}[label={sec:org2d6cebe}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0061672}
\begin{frame}[label={sec:org5864ab2}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org34e6553}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgae083cd},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org831d60e}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8d21d20}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org765ed3f}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org708c7cd}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org758ecb5}]{Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org8f1f94b}
\begin{frame}[label={sec:orgb33766e}]{Freedom (EmacsConf 2021)}
...
\label{sec:orgdd7afbc}
\begin{frame}[label={sec:org34a8c4a},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org9decdd3}
\begin{frame}[label={sec:orgab3b707}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgdbdfcc7}
\begin{frame}[label={sec:orgbf626f5},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org6e30174}
\begin{frame}[label={sec:org4a523c1},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:org263cfe1}
\subsection{Pen.el v2}
\label{sec:orgbe9f17b}
\begin{verbatim}
 1  phenomenology
