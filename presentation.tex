...
\label{sec:org721e568}
\begin{frame}[label={sec:org3c1e93e}]{Following along}
...
\label{sec:org0f01792}
\begin{frame}[label={sec:org19114e5},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org6a1aa4d}
\begin{frame}[label={sec:org555ab0c}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org783de44}
\begin{frame}[label={sec:org2526868},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgfb6a8a7}
\begin{frame}[label={sec:org0fa6784},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgad8fa18}
\begin{frame}[label={sec:orgd26a5ed},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org24ef7c1}
\begin{frame}[label={sec:orgfe2854b}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orga25339b}
\begin{frame}[label={sec:org2d358f8}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org719607e}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2fb70aa}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org7867843}]{Philosophy}
...
\begin{frame}[label={sec:org4d08e9d}]{Philosophy}
...
\begin{frame}[label={sec:org6ee5f20}]{Philosophy}
...
\begin{frame}[label={sec:org197e518}]{Philosophy}
...
\section{Freedom}
\label{sec:orgc78236e}
\begin{frame}[label={sec:orgbd7a7d2}]{Freedom}
...
\label{sec:org261646b}
\begin{frame}[label={sec:org5039e1d},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgb8e0b0e}
\begin{frame}[label={sec:org7f9f214}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgfcc0f5c}
\begin{frame}[label={sec:orge147d8b},fragile]{𝑖λ (ilambda.el)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgf246133}
\begin{frame}[label={sec:org3475cc4},fragile]{𝑖λ (ilambda.el)}
