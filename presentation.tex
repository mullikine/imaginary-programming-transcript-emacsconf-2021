...
\label{sec:orgae42a8a}
\begin{frame}[label={sec:orgc975b0c}]{Following along}
...
\label{sec:org3170e76}
\begin{frame}[label={sec:org19e1532},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:org932a548}
\begin{frame}[label={sec:orgf30ca84}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org1f55146}
\begin{frame}[label={sec:org7722723},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org04adb35}
\begin{frame}[label={sec:org2eab0a4},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org1a31ddb}
\begin{frame}[label={sec:orgbd8df63},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orga042e04}
\begin{frame}[label={sec:orga4b5b98},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org68512df}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org43c7f8c}]{Philosophy}
...
\begin{frame}[label={sec:orge7d238b}]{Philosophy}
...
\begin{frame}[label={sec:org95a665e}]{Philosophy}
...
\begin{frame}[label={sec:org2a63ae8}]{Philosophy}
...
\label{sec:org18820a3}
\subsection{GPT-3}
\label{sec:org3fab2d9}
\begin{frame}[label={sec:org0441fe0},fragile]{Text Generator}
...
\label{sec:orgab1c4c5}
\begin{frame}[label={sec:org101bd01},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org375a709},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org2c88017}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org4c19760}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgab8d686}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org67fd0b9},fragile]{Design patterns}
...
\begin{frame}[label={sec:org6e1026a},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6664bba},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org7f3b544},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6eec063},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org777aaeb}]{Techniques}
...
\label{sec:org23a12dc}
\subsection{Using \texttt{pen.el}}
\label{sec:orgaca648c}
\begin{frame}[label={sec:org7bbbf15},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgd354407}
\begin{frame}[label={sec:orge233552},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgf2cccb0}
\begin{frame}[label={sec:orgbc09e08},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgb7baef5},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgc050345},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org4072d27},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgc155f0e}
\subsection{\texttt{pen.el}}
\label{sec:org5b03a30}
\begin{frame}[label={sec:org45e8450},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orga96cfee}
\begin{frame}[label={sec:orgb02635a},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgf06e2f7},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org1b23567}
\begin{frame}[label={sec:orgceafab7}]{Something funny}
...
\begin{frame}[label={sec:org2a7ddc6}]{Something funny}
...
\begin{frame}[label={sec:org3398dd2}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgb66bafa}
\subsection{Additional reading}
\label{sec:org9df6890}
\begin{frame}[label={sec:orgaeabfa7}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
