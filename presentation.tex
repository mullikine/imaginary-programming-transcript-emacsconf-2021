...
\label{sec:orgf840a50}
\begin{frame}[label={sec:org1e5a50a},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org60ddb67}
\begin{frame}[label={sec:org53009a7}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgfc77952}
\begin{frame}[label={sec:orgab7db33},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1151000}
\begin{frame}[label={sec:org5d81298},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0b5d9fc}
\begin{frame}[label={sec:org1d5c835},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgabe8f58}
\begin{frame}[label={sec:orgb15c472}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1410067}
\begin{frame}[label={sec:org73d7cae}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd04ed9e},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf49dd00}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4e65af9}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\label{sec:org71f15ab}
\begin{frame}[label={sec:org9f2ffb1},fragile]{Imaginary Programming (EmacsConf 2021)}
