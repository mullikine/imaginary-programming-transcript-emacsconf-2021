...
\label{sec:orgacf634f}
\begin{frame}[label={sec:org25ed5ed}]{Following along}
...
\label{sec:orgb20c4b7}
\begin{frame}[label={sec:org86487db},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgd27df4b}
\begin{frame}[label={sec:org4b075e0}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org7c675d6}
\begin{frame}[label={sec:org1dad63e},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgdf782db}
\begin{frame}[label={sec:orgc21c489},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org9f583fd}
\begin{frame}[label={sec:org31d033e},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org8a11022}
\begin{frame}[label={sec:org533df87}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org8938667}
\begin{frame}[label={sec:orgde8c546}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org448ab30}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb78f6aa}]{Paracosm vs Metaverse}
...
imaginary metaverse. This is what is at
stake.
\end{itemize}
\end{itemize}
\item Metaverse
...
\item An AI paying a Dowry. An AI NFT elevated above a human.
\end{itemize}
\end{itemize}
\end{block}
\end{frame}

\begin{frame}[label={sec:org2a309c0}]{Philosophy}
...
\begin{frame}[label={sec:org1397811}]{Philosophy}
...
\begin{frame}[label={sec:org9077c71}]{Philosophy}
...
\begin{frame}[label={sec:org26cfd95}]{Philosophy}
...
\section{Freedom}
\label{sec:org1a0191e}
\begin{frame}[label={sec:orgea4982a}]{Freedom}
...
\label{sec:org58b2829}
\begin{frame}[label={sec:orgce92ef6},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgf2918d4}
\begin{frame}[label={sec:org1d07f63}]{Blockchain and a Language model is all you need}
