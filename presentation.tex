...
\label{sec:orgbdc0583}
\begin{frame}[label={sec:org7ec511d},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orga4f83c4}
\begin{frame}[label={sec:orga624efe},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org1a64bc2}
\begin{frame}[label={sec:orgcd72687}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9bf45b2}
\begin{frame}[label={sec:orgbd442ad},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org31c05de}
\begin{frame}[label={sec:org6c5124c},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org6ae499f}
\begin{frame}[label={sec:orge4082f9},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5e42846}
\begin{frame}[label={sec:org1714b26}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org86b642f}
\begin{frame}[label={sec:orgc6e1a6f}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org24b26b1}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7f0db02},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4008a7c}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1d7a205}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org28c0e65}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb60328f}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5d33af6},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org3a56185}
\begin{frame}[label={sec:org44c1ba8},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgd1a1860}
\begin{frame}[label={sec:org7dfb753},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orga8fd479}
\begin{frame}[label={sec:orgfd8a81f}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgc4d80dc}
\begin{frame}[label={sec:org5e09975},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orga07e126}
\begin{frame}[label={sec:orgdc17e78},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgc9242d4}
\begin{frame}[label={sec:orgb25bb72},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{block}{Example. It's used as a primitive to the \texttt{ilambda.el} \texttt{ilambda}}
{\tiny
\begin{verbatim}
1  (ieval
...
\section{ilambda}
\label{sec:orgb21d954}
\begin{frame}[label={sec:org89ea831},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{\texttt{ilambda}}
\end{block}
\end{frame}

\begin{frame}[label={sec:orgaac6f18},fragile]{\texttt{imacro} generates code}
 {\tiny
