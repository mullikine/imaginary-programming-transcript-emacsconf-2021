...
\label{sec:org897b394}
\begin{frame}[label={sec:org835a469}]{Following along}
...
\label{sec:org6b87753}
\begin{frame}[label={sec:org0d8b896},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org5d35ac2}
\begin{frame}[label={sec:org7a77dbc}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org65d8a86}
\begin{frame}[label={sec:orgd265dd0},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgbef5edf}
\begin{frame}[label={sec:orgf535505},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org28c9e74}
\begin{frame}[label={sec:org57621ec},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org24420f0}
\begin{frame}[label={sec:org37b94ad}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org0d5b540}
\begin{frame}[label={sec:org32ce80a}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgad271cd}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org828076c},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org7007166}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8360fdd}]{Philosophy}
...
\begin{frame}[label={sec:org6ca1cd2}]{Philosophy}
...
\begin{frame}[label={sec:org0aa01de}]{Philosophy}
...
\begin{frame}[label={sec:org42b786c}]{Philosophy}
...
\section{Freedom}
\label{sec:org2856414}
\begin{frame}[label={sec:org2d5cfee}]{Freedom}
...
\label{sec:org3ffcff4}
\begin{frame}[label={sec:orgd75f5ab},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgda88639}
\begin{frame}[label={sec:org22e91b6}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org8b16589}
\begin{frame}[label={sec:orge67bfda},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org4bf2ebb}
\begin{frame}[label={sec:orgb028cb5},fragile]{ilambda.el}
