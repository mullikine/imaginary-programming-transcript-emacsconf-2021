...
\label{sec:org2bca986}
\begin{frame}[label={sec:org43c8fe6}]{Following along}
...
\label{sec:org35bfbd1}
\begin{frame}[label={sec:org60a3cec},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org64551f0}
\begin{frame}[label={sec:org79ffa16}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org9071f0b}
\begin{frame}[label={sec:orgc3263b9},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org4dfb363}
\begin{frame}[label={sec:org74bdd11},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orga04e0e1}
\begin{frame}[label={sec:org2d935c6},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgcc1ba0a}
\begin{frame}[label={sec:orga2848f3}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org1e73ee5}
\begin{frame}[label={sec:orgd1e9ebf}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgc6f17fa}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8fc7b7c},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb66f20e}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgbdd7056}]{Philosophy}
...
\begin{frame}[label={sec:orga95a77b}]{Philosophy}
...
\begin{frame}[label={sec:org7e526e9}]{Philosophy}
...
\begin{frame}[label={sec:org1073b57}]{Philosophy}
...
\section{Freedom}
\label{sec:org714bc92}
\begin{frame}[label={sec:orgd0f875c}]{Freedom}
{\tiny
...
\begin{itemize}
\item they are so large and hidden behind SAAS,
...
\label{sec:org1508010}
\begin{frame}[label={sec:org5946fb4},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:org60674b8}
\begin{frame}[label={sec:org055d1b1}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgcbe8aa0}
\begin{frame}[label={sec:org9c203a6},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgd8cf648}
\begin{frame}[label={sec:org54794c6},fragile]{ilambda.el}
