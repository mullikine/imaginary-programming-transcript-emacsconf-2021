...
\label{sec:orged85f41}
\begin{frame}[label={sec:org8d2303a}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org9cc8982}
\begin{frame}[label={sec:org385bed1},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org7f75c04}
\begin{frame}[label={sec:org7aebaf8}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org12eaf08}
\begin{frame}[label={sec:orgf8fe956},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org87e40ed}
\begin{frame}[label={sec:org2c8d8e5},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org57ce89b}
\begin{frame}[label={sec:orga9af82c},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4cd041d}
\begin{frame}[label={sec:orgd470943}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org395ec43}
\begin{frame}[label={sec:org2c0b6e0}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgdb52184}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgad70de6},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgbd1cc2b}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc85f55b}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb916d86}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcfd6345}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org21beb65}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org1bbc966}
\begin{frame}[label={sec:org1ce6859},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org403ad85}
\begin{frame}[label={sec:orga0b0e7d},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org0985c73}
\begin{frame}[label={sec:orge5cc94b}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orge89716d}
\begin{frame}[label={sec:orga018350},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org7f7675a}
\begin{frame}[label={sec:org7a3705c},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org244992c},fragile]{\texttt{imacro}}
...
\label{sec:org4ac01aa}
\subsection{Pen.el v2}
\label{sec:org4b64a26}
\begin{verbatim}
 1  phenomenology
