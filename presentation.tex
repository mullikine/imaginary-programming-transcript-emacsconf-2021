...
\label{sec:org1570178}
\begin{frame}[label={sec:org291d3cb}]{Following along}
...
\label{sec:orgb44a2d6}
\begin{frame}[label={sec:orgdb73993},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgabc5996}
\begin{frame}[label={sec:org52195ef}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org9ef44cf}
\begin{frame}[label={sec:org6f9ee2b},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org481d3de}
\begin{frame}[label={sec:org2b5b70c},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgc29b030}
\begin{frame}[label={sec:org2b51352},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgad8c05d}
\begin{frame}[label={sec:org382bbd9},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org39fc164}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orga55180f}]{Philosophy}
...
\begin{frame}[label={sec:orge0feb3c}]{Philosophy}
...
\begin{frame}[label={sec:org7e45f74}]{Philosophy}
...
\begin{frame}[label={sec:org394702b}]{Philosophy}
...
\label{sec:org63d6857}
\subsection{GPT-3}
\label{sec:org958e4b7}
\begin{frame}[label={sec:org71826d6},fragile]{Text Generator}
...
\label{sec:org4aa5a2f}
\begin{frame}[label={sec:org818520e},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgfe0addd},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org173cfba}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgcf6a31f}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org5d99d38}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgd8eb04f},fragile]{Design patterns}
...
\begin{frame}[label={sec:org108b4e4},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org8a3be82},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgd4addd6},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org63ac404},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org89a94b0}]{Techniques}
...
\label{sec:orgb9ea8af}
\subsection{Using \texttt{pen.el}}
\label{sec:org392555a}
\begin{frame}[label={sec:orgbdd3c36},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgf97ea84}
\begin{frame}[label={sec:org9caef9f},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org69df2f5}
\begin{frame}[label={sec:orga127841},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org3a1fd2c},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgdf19035},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org6343b47},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org576aeed}
\subsection{\texttt{pen.el}}
\label{sec:orga708aca}
\begin{frame}[label={sec:org2241ae1},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org4208a59}
\begin{frame}[label={sec:org1998e97},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orge6bf6ca},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgbd2ef4e}
\begin{frame}[label={sec:org3634f4e}]{Something funny}
...
\begin{frame}[label={sec:org8c48321}]{Something funny}
...
\begin{frame}[label={sec:org551c19e}]{Create a prompt}
...
\section{Appendix}
\label{sec:org31cae8b}
\subsection{Additional reading}
\label{sec:org0b0164b}
\begin{frame}[label={sec:orgf474437}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
