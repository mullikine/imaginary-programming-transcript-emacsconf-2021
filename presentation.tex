...
\label{sec:orgef99d49}
\begin{frame}[label={sec:org9192d97}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org95abb83}
\begin{frame}[label={sec:org88caa4f},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge09fd15}
\begin{frame}[label={sec:orgebcdcd0}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orge9a0f96}
\begin{frame}[label={sec:org6efa680},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org6c54c38}
\begin{frame}[label={sec:orgc441776},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5531419}
\begin{frame}[label={sec:org96530a4},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9f8834b}
\begin{frame}[label={sec:orgf1b791e}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1664c6c}
\begin{frame}[label={sec:orgdb553ef}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf6fbc0f}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org414fa5f},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5a00a05}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9220768}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org3a341b1}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org53f7c3c}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf38688d}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org7a3ef8b}
\begin{frame}[label={sec:org7dbde4f},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org5b202b2}
\begin{frame}[label={sec:org0276fe2},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org4907e44}
\begin{frame}[label={sec:org0bfa279}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgac893a2}
\begin{frame}[label={sec:org20235a7},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgff809fc}
\begin{frame}[label={sec:org61f3cd5},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orgb3122d0}
\subsection{Pen.el v2}
\label{sec:orgeeb664c}
\begin{verbatim}
 1  phenomenology
