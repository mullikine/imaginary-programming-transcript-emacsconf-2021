...
\label{sec:org93e8174}
\begin{frame}[label={sec:orgea9dbfb}]{Following along}
...
\label{sec:org8302ef6}
\begin{frame}[label={sec:orgb68a656},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org4068df6}
\begin{frame}[label={sec:org238c543}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org911c31f}
\begin{frame}[label={sec:org4e15127},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org4290d4e}
\begin{frame}[label={sec:org557a954},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org68fd600}
\begin{frame}[label={sec:orgd7ef234},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgb6d4b83}
\begin{frame}[label={sec:orgd78ea1d}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgfa85b4c}
\begin{frame}[label={sec:org29f25dd}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org32748ec}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org24b6adb}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb4f37fb}]{Philosophy}
...
\begin{frame}[label={sec:org8622041}]{Philosophy}
...
\begin{frame}[label={sec:orgd31956e}]{Philosophy}
...
\begin{frame}[label={sec:org9c24e51}]{Philosophy}
...
\section{Freedom}
\label{sec:org0a612bf}
\begin{frame}[label={sec:org130ba95}]{Freedom}
...
\label{sec:org723041c}
\begin{frame}[label={sec:org6a914af},fragile]{Imaginary Programming}
...
\label{sec:orge2eb204}
\subsection{Using \texttt{pen.el}}
\label{sec:org1a7ffdf}
\begin{frame}[label={sec:org857c019},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org00e6169}
\begin{frame}[label={sec:org111b79d},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org4a6058c}
\begin{frame}[label={sec:orgbb738bb},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgea6a869},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgb43c287},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org4ce2400},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org2f62d2d}
\subsection{\texttt{pen.el}}
\label{sec:orge2de227}
\begin{frame}[label={sec:org604511f},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org56b6d68}
\begin{frame}[label={sec:org7bd3a77},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org83e0241},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orga5917a6}
\begin{frame}[label={sec:org3199174}]{Something funny}
...
\begin{frame}[label={sec:org5110be5}]{Something funny}
...
\begin{frame}[label={sec:org2649ae0}]{Create a prompt}
...
\section{Appendix}
\label{sec:org5f8ffef}
\subsection{Additional reading}
\label{sec:orgdd525f7}
\begin{frame}[label={sec:orgfa63393}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
