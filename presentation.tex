...
\label{sec:orgc348f85}
\begin{frame}[label={sec:orge8bee6f}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org840fb75}
\begin{frame}[label={sec:org3774541},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgea10818}
\begin{frame}[label={sec:org04da929}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orga376468}
\begin{frame}[label={sec:orgc993729},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org94a6a1c}
\begin{frame}[label={sec:org648043e},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgb70374e}
\begin{frame}[label={sec:org08ca989},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgb3d0cd6}
\begin{frame}[label={sec:orgb3877f9}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgccbb708}
\begin{frame}[label={sec:org36b668d}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org97beb67}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org04a9efd},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org832b87a}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org445204e}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0bced9d}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgee96efd}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2432b80}]{Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org5177818}
\begin{frame}[label={sec:org416e775}]{Freedom (EmacsConf 2021)}
...
\label{sec:orgc960f7c}
\begin{frame}[label={sec:org0e9ffaa},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgae4fb72}
\begin{frame}[label={sec:org5c912e6}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgd8dbd03}
\begin{frame}[label={sec:org891a2b1},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org01c7e90}
\begin{frame}[label={sec:org67acace},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orgc0b2690}
\subsection{Pen.el v2}
\label{sec:org0c9381a}
\begin{verbatim}
 1  phenomenology
