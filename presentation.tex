...
\label{sec:orgc133427}
\begin{frame}[label={sec:org79fb290},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
 {\tiny
...
\texttt{ieval}, \texttt{imacro} or \texttt{ilist}.
}
...
\label{sec:orgb338568}
\begin{frame}[label={sec:org0bc7725},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgf8f4132}
\begin{frame}[label={sec:org34bcf22}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgea1b1b5}
\begin{frame}[label={sec:orge78c94b},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orga39024b}
\begin{frame}[label={sec:org2e6f3ef},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org93e5b45}
\begin{frame}[label={sec:org13b1701},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3b17e70}
\begin{frame}[label={sec:orgdc0c588}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orge704c32}
\begin{frame}[label={sec:org51b53fb}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb1af3eb}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org797ae05},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5535ef3}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4cc4e44}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgebfbd7b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org398957f}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga30a67e},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org9df75ab}
\begin{frame}[label={sec:orgae3f7a9},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgf09d0e7}
\begin{frame}[label={sec:orgeaabfea},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd890db9}
\begin{frame}[label={sec:orgdaa2553}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org7504b5c}
\begin{frame}[label={sec:org129f5d7},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgbdb9051}
\begin{frame}[label={sec:org0a4bd58},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4962005},fragile]{\texttt{imacro}}
...
\label{sec:org2a8b26d}
\subsection{Pen.el v2}
\label{sec:org4e479a2}
\begin{verbatim}
 1  phenomenology
