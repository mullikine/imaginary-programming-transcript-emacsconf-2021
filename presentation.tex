...
\label{sec:org160f4b7}
\begin{frame}[label={sec:orgf85543b},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org06c3416}
\begin{frame}[label={sec:org9b86bed},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org432ffa7}
\begin{frame}[label={sec:orgdcfb380}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1c1e770}
\begin{frame}[label={sec:org4dd49c7},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgcbcf5ed}
\begin{frame}[label={sec:orgee90df9},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org951f918}
\begin{frame}[label={sec:org9c59137},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org95c8165}
\begin{frame}[label={sec:orgbbca15d}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf2b98c1}
\begin{frame}[label={sec:org01d5d64}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6d8ca40}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgae8e748},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge24abef}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2715308}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org50e5738}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1a3c8dc}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4488af4},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orga9f12b1}
\begin{frame}[label={sec:org963cec1},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org2794cc3}
\begin{frame}[label={sec:org02945cf},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org1362480}
\begin{frame}[label={sec:org686b0e3}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgd2cc815}
\begin{frame}[label={sec:orgbdfa115},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org4ac9a0a}
\begin{frame}[label={sec:orgdddfa4b},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orga98b293}
\begin{frame}[label={sec:org93e2f31},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgdce832c}
\begin{frame}[label={sec:orgeb685df},fragile]{ilambda.el (EmacsConf 2021)}
