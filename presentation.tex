...
\label{sec:org75a3d57}
\begin{frame}[label={sec:orga16ce69}]{Following along}
...
\label{sec:orgd75ca5b}
\begin{frame}[label={sec:org3a8d4cf},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org7036931}
\begin{frame}[label={sec:org9c34c98}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org5fa3313}
\begin{frame}[label={sec:orgc943336},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgabef21e}
\begin{frame}[label={sec:org84c3332},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org720a6ad}
\begin{frame}[label={sec:org9ed0a32},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgf768638}
\begin{frame}[label={sec:org4ed8960}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org5f567b7}
\begin{frame}[label={sec:org9fd4a7b}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org00e2893}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgbfaead6}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org7345283}]{Philosophy}
...
\begin{frame}[label={sec:org8ecb178}]{Philosophy}
...
\begin{frame}[label={sec:orgf680ecc}]{Philosophy}
...
\begin{frame}[label={sec:org9b9711e}]{Philosophy}
...
\section{Freedom}
\label{sec:orgdd3f7ed}
\begin{frame}[label={sec:org7d740ee}]{Freedom}
...
\label{sec:orgb18c369}
\begin{frame}[label={sec:org1520726},fragile]{Imaginary Programming}
...
\begin{verbatim}
"\"[((name . \\\"guix\\\") (description . \\\"The GNU package manager\\\") (updated_at . \\\"2014-04-21T18:49:59Z\\\") (created_at . \\\"2014-04-21T18:49:59Z\\\") (pushed_at . \\\"2014-04-21T18:49:59Z\\\")) ((name . \\\"guix-patches\\\") (description . \\\"Packages from the GNU guix package manager\\\") (updated_at . \\\"2014-04-21T18:49:59Z\\\") (created_at . \\\"2014-04-21T18:49:59Z\\\") (pushed_at . \\\"2014-04-21T18:49:59Z\\\")) ((name . \\\"guix-patches-all\\\") (description . \\\"Packages from the GNU guix package manager\\\") (updated_at . \\\"2014-04-21T18:49:59\""
\end{verbatim}
\end{block}
\end{frame}

\section{Explanations}
\label{sec:orgf1a2b6b}
\subsection{Using \texttt{pen.el}}
\label{sec:orge4c22bc}
\begin{frame}[label={sec:orga53c264},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org9ad0fda}
\begin{frame}[label={sec:org0ee315a},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orge264443}
\begin{frame}[label={sec:org475d458},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgc94d28c},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org1c40757},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org5842b7f},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org8c26bbf}
\subsection{\texttt{pen.el}}
\label{sec:org15394b5}
\begin{frame}[label={sec:org9debfa1},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgce9e938}
\begin{frame}[label={sec:org62fea18},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgb3b957f},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org8553d57}
\begin{frame}[label={sec:org1edad98}]{Something funny}
...
\begin{frame}[label={sec:org5a6a773}]{Something funny}
...
\begin{frame}[label={sec:orgb00c4ad}]{Create a prompt}
...
\section{Appendix}
\label{sec:org2d3a3b7}
\subsection{Additional reading}
\label{sec:org218174a}
\begin{frame}[label={sec:orgf955cb5}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
