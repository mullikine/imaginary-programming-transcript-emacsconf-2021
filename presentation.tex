...
\label{sec:orgfd2839e}
\begin{frame}[label={sec:orgc74f5e5}]{Following along}
...
\label{sec:orgd3cb7c7}
\begin{frame}[label={sec:org7c72ffb},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org2acb656}
\begin{frame}[label={sec:orgd7d0876}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orgbf45c0e}
\begin{frame}[label={sec:org7db6efc},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgb477f99}
\begin{frame}[label={sec:org21793f7},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org4e8925c}
\begin{frame}[label={sec:orge65ebff},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org9931cff}
\begin{frame}[label={sec:org8be65c1}]{Imaginary Computing: Potential Dystopia}
