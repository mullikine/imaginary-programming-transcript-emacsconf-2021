...
\label{sec:org333c82a}
\begin{frame}[label={sec:org3aa4b6e}]{Following along}
...
\label{sec:orgfbd1c7d}
\subsection{GPT-3}
\label{sec:orgc4146a3}
\begin{frame}[label={sec:orgc954a39},fragile]{Text Generator}
...
\label{sec:orgd0fb2e4}
\begin{frame}[label={sec:orgd334f48},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgd9abfc2},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org1c98fbf}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org5dd658c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org2df25f8}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org64a1729},fragile]{Design patterns}
...
\begin{frame}[label={sec:org2abbb68},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgb957395},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgb813821},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgc43d74c},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgbf00301}]{Techniques}
...
\label{sec:org458ea17}
\subsection{Using \texttt{pen.el}}
\label{sec:orgffd4f1b}
\begin{frame}[label={sec:org60d963f},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org92ed1a2}
\begin{frame}[label={sec:orgd2f99d9},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org62f444c}
\begin{frame}[label={sec:orgb8090ba},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org6881f0c},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orga86cc0c},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org959ebff},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org5117971}
\subsection{\texttt{pen.el}}
\label{sec:org9e93c4d}
\begin{frame}[label={sec:org9577548},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org0008a30}
\begin{frame}[label={sec:org0ad3e75},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org27a6131},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orge5239b1}
\begin{frame}[label={sec:org6475851}]{Something funny}
...
\begin{frame}[label={sec:orge85efa4}]{Something funny}
...
\begin{frame}[label={sec:org0526aef}]{Create a prompt}
...
\section{Appendix}
\label{sec:org6f590a4}
\subsection{Additional reading}
\label{sec:org236146d}
\begin{frame}[label={sec:org53787ba}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
