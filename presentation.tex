...
\label{sec:org6665d11}
\begin{frame}[label={sec:org1099a06}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgea4e11b}
\begin{frame}[label={sec:org8f991f0},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc459a7c}
\begin{frame}[label={sec:org95c504a}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgb915bd3}
\begin{frame}[label={sec:orge70a58b},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0d25812}
\begin{frame}[label={sec:org6a9c694},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3e3c059}
\begin{frame}[label={sec:orgdf9ca4e},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4b4e18c}
\begin{frame}[label={sec:orgc289b99}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org96abda4}
\begin{frame}[label={sec:org34f04c3}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org42e36df}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga464d2e},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org852325d}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org477d863}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org391d060}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org86d8719}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5aaa04c},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org49b08df}
\begin{frame}[label={sec:orgb11cefd},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org967d006}
\begin{frame}[label={sec:org0c74a90},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgf661b1d}
\begin{frame}[label={sec:org4ba7ef3}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org950fbfb}
\begin{frame}[label={sec:org0dae2f7},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org09aac72}
\begin{frame}[label={sec:org2b6f9b3},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2d7d258},fragile]{\texttt{imacro}}
...
\label{sec:org44c8142}
\subsection{Pen.el v2}
\label{sec:orgc168e4c}
\begin{verbatim}
 1  phenomenology
