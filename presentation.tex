...
\label{sec:org6708e1c}
\begin{frame}[label={sec:org3d2cf95}]{Following along}
...
\label{sec:org6265eb1}
\begin{frame}[label={sec:orgdbf5a16},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:orgaa91948}
\begin{frame}[label={sec:orgd8a74eb}]{AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org17e9ebe}
\begin{frame}[label={sec:org05e5870}]{Emacs as the command-center for prompting}
...
\section{Imaginary Computing}
\label{sec:org44c7f42}
\begin{frame}[label={sec:org077229f},fragile]{Blockchain}
...
\section{Imaginary Computing}
\label{sec:org0ba6f33}
\begin{frame}[label={sec:org37f986b},fragile]{Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orge2c873b}
\begin{frame}[label={sec:orgb8a1b02},fragile]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org9294330}]{Paracosm vs Metaverse}
...
\label{sec:orge09bf4c}
\subsection{GPT-3}
\label{sec:orgfc6008e}
\begin{frame}[label={sec:org81cdf82},fragile]{Text Generator}
...
\label{sec:orgbb06d66}
\begin{frame}[label={sec:org49fc8db},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org10c9b01},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org1dfd4c4}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org53f6be6}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgfbfb2bc}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgcc9efbf},fragile]{Design patterns}
...
\begin{frame}[label={sec:org350d586},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6920147},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org72133e7},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4b8d4e7},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6ce25d5}]{Techniques}
...
\label{sec:orgbbd50cf}
\subsection{Using \texttt{pen.el}}
\label{sec:org5da34d2}
\begin{frame}[label={sec:org68be4ef},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgc5c4d22}
\begin{frame}[label={sec:orgf7d33d1},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org3f8e408}
\begin{frame}[label={sec:orgc259be3},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgfbcb61a},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgfed1ba9},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org105bcec},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgc34cfb5}
\subsection{\texttt{pen.el}}
\label{sec:org5c4dedd}
\begin{frame}[label={sec:orgc362d72},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org896bb40}
\begin{frame}[label={sec:org41fce1a},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgf2b037a},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgcd044ef}
\begin{frame}[label={sec:org0d0ebd9}]{Something funny}
...
\begin{frame}[label={sec:orge51f9f7}]{Something funny}
...
\begin{frame}[label={sec:org6ed5be0}]{Create a prompt}
...
\section{Appendix}
\label{sec:org0a3e911}
\subsection{Additional reading}
\label{sec:orge2b80a9}
\begin{frame}[label={sec:orgd2cceb1}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
