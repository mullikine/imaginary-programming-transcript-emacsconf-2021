...
\label{sec:orgb7fa4b1}
\begin{frame}[label={sec:org645e655}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgf96f114}
\begin{frame}[label={sec:org6e06c9d},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org9696428}
\begin{frame}[label={sec:org7fe42da}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9188ed2}
\begin{frame}[label={sec:org40d4ac9},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org6c9f11b}
\begin{frame}[label={sec:org3c58257},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org32084a0}
\begin{frame}[label={sec:orgf3e7796},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8d0b636}
\begin{frame}[label={sec:orgb1b23ec}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgad03c31}
\begin{frame}[label={sec:org52749c4}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7b2fb0a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb5e4559},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org10186df}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org92d6188}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7809bc7}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgacc2bbb}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcaba08f},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org2bee693}
\begin{frame}[label={sec:org33c29de},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org8b732ed}
\begin{frame}[label={sec:orgdb5cfc4},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5b1dc4e}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgd76f44a}
\begin{frame}[label={sec:org29de266},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org6d17ffa}
\begin{frame}[label={sec:org39ae4d3},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgba0d2c2},fragile]{\texttt{imacro}}
...
\label{sec:orgcbb77ef}
\subsection{Pen.el v2}
\label{sec:orgff58207}
\begin{verbatim}
 1  phenomenology
