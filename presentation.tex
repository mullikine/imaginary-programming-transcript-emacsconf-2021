...
\label{sec:org90d1917}
\begin{frame}[label={sec:orge9ef583}]{Following along}
...
\label{sec:org335f05f}
\begin{frame}[label={sec:org83c15dc},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:org760be84}
\begin{frame}[label={sec:org108f5bc}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org2018980}
\begin{frame}[label={sec:org55b1ff2},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org44081ea}
\begin{frame}[label={sec:orgfded2e7},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgd7b726d}
\begin{frame}[label={sec:org3ed72d9},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org7ff5ad4}
\begin{frame}[label={sec:org41269c4},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgf82007d}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgf013fe3}]{Philosophy}
...
\begin{frame}[label={sec:org85dc47a}]{Philosophy}
...
\begin{frame}[label={sec:org6052417}]{Philosophy}
...
\begin{frame}[label={sec:orgec69451}]{Philosophy}
\begin{block}{Structuralism: Language based on sign relations}
...
\label{sec:org608f841}
\subsection{GPT-3}
\label{sec:orgd39c9d7}
\begin{frame}[label={sec:org5391f24},fragile]{Text Generator}
...
\label{sec:orgcd1a581}
\begin{frame}[label={sec:orge5fd516},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org6ba2061},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org8c07391}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgf6e2e09}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orga001793}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org34901ec},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgd4daab2},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgf49a662},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgba0ad0f},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org05abf24},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org3aefb3b}]{Techniques}
...
\label{sec:orgad859ed}
\subsection{Using \texttt{pen.el}}
\label{sec:orgf4e6398}
\begin{frame}[label={sec:org3e40abc},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org9357510}
\begin{frame}[label={sec:org5993303},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgb904893}
\begin{frame}[label={sec:org52f426e},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org6a36b39},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgff6d903},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgfcb8b38},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org15b13b7}
\subsection{\texttt{pen.el}}
\label{sec:orgf67a3f0}
\begin{frame}[label={sec:orgcf1c70d},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org7cdd08a}
\begin{frame}[label={sec:org5b66e45},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org6195ece},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orge7c7a70}
\begin{frame}[label={sec:orgf6e5b18}]{Something funny}
...
\begin{frame}[label={sec:org1cbac52}]{Something funny}
...
\begin{frame}[label={sec:org24e1425}]{Create a prompt}
...
\section{Appendix}
\label{sec:orga5a5f3a}
\subsection{Additional reading}
\label{sec:orgf30b2a4}
\begin{frame}[label={sec:org9543daf}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
