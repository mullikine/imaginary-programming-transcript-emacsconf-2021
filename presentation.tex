...
\label{sec:orgd8a6dd0}
\begin{frame}[label={sec:org90b99d5}]{Following along}
...
\label{sec:orgd891aa1}
\begin{frame}[label={sec:org813a966},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org86b9e92}
\begin{frame}[label={sec:org928830a}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orgc6e30a4}
\begin{frame}[label={sec:org3337452},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org3db3088}
\begin{frame}[label={sec:org9a470f8},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org30e6b95}
\begin{frame}[label={sec:org3a1b8fa},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgabc090b}
\begin{frame}[label={sec:orgff7251b}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org0a8efcd}
\begin{frame}[label={sec:org9ed34b2}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orge1b8f29}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org4268323}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgd476bdc}]{Philosophy}
...
\begin{frame}[label={sec:orgdb8628f}]{Philosophy}
...
\begin{frame}[label={sec:org5ad07cf}]{Philosophy}
...
\begin{frame}[label={sec:orgc532255}]{Philosophy}
...
\section{Freedom}
\label{sec:orgff1844a}
\begin{frame}[label={sec:org999c44f}]{Freedom}
...
\label{sec:orge091427}
\begin{frame}[label={sec:orgd5805ce}]{Methodology}
Interactively use the language model to imagine.
\end{frame}

\begin{frame}[label={sec:orgc5bd3c1},fragile]{Paradigm}
 \begin{block}{Literate programming with \texttt{org-mode}}
An extension of literate programming.
\end{block}
\end{frame}

\begin{frame}[label={sec:orgd36e098}]{Practical application: mocking APIs}
\begin{block}{ilambda}
\end{block}
\end{frame}

\section{Explanations}
\label{sec:org962163c}
\subsection{Using \texttt{pen.el}}
\label{sec:org1a0a60c}
\begin{frame}[label={sec:orgf6c58ea},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org059c126}
\begin{frame}[label={sec:orgd1d06be},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orga60b62d}
\begin{frame}[label={sec:orgfc8d22f},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org5c646c5},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orga5f175e},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org53258eb},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org4963b67}
\subsection{\texttt{pen.el}}
\label{sec:orge0258ee}
\begin{frame}[label={sec:org65537da},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org1122734}
\begin{frame}[label={sec:org35ae5e7},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgc4b8c50},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org6e50de3}
\begin{frame}[label={sec:org6f8681a}]{Something funny}
...
\begin{frame}[label={sec:orgbdfd266}]{Something funny}
...
\begin{frame}[label={sec:orgc2262e1}]{Create a prompt}
...
\section{Appendix}
\label{sec:org5dac41e}
\subsection{Additional reading}
\label{sec:orgcfc73c0}
\begin{frame}[label={sec:orgeeb1308}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
