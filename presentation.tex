...
\label{sec:org642658d}
\begin{frame}[label={sec:org7b1f8aa}]{Following along}
...
\label{sec:org5a7ad97}
\begin{frame}[label={sec:org5f7adb8},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org776b3ab}
\begin{frame}[label={sec:org554a910}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org237693f}
\begin{frame}[label={sec:orgd8e072c},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org44866bf}
\begin{frame}[label={sec:orga120d2b},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgb45837e}
\begin{frame}[label={sec:org471466d},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org667609c}
\begin{frame}[label={sec:org53990b4}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org4efff4f}
\begin{frame}[label={sec:orgc3f13b8}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8c3b757}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org3713de6},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org17b886e}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org6c026af}]{Philosophy}
...
\begin{frame}[label={sec:org49d61a8}]{Philosophy}
...
\begin{frame}[label={sec:org7745077}]{Philosophy}
...
\begin{frame}[label={sec:org21413a9}]{Philosophy}
...
\section{Freedom}
\label{sec:orgeddfe76}
\begin{frame}[label={sec:orgbdd56fd}]{Freedom}
...
\label{sec:org14e19da}
\begin{frame}[label={sec:org5e8bfe0},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgfff3d77}
\begin{frame}[label={sec:org9e42be7}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org03f9bef}
\begin{frame}[label={sec:org874aff9},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org9afa0b4}
\begin{frame}[label={sec:org75d1cde},fragile]{ilambda.el}
