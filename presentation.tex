...
\label{sec:orged1e90a}
\begin{frame}[label={sec:org0849d10}]{Following along}
...
\label{sec:org7f30efa}
\begin{frame}[label={sec:org94da548},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgbac0a1e}
\begin{frame}[label={sec:org88c016e}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org101c52e}
\begin{frame}[label={sec:orgbefc484},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org605f40c}
\begin{frame}[label={sec:orgfd8187b},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org7433a69}
\begin{frame}[label={sec:org353b0ec},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgf33b7bd}
\begin{frame}[label={sec:orge340b1e}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org5a766e1}
\begin{frame}[label={sec:orgce0a9fe}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org6079dc0}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgd468d6f}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgfb4fc26}]{Philosophy}
...
\begin{frame}[label={sec:org900319c}]{Philosophy}
...
\begin{frame}[label={sec:orgd994667}]{Philosophy}
...
\begin{frame}[label={sec:org04f4f6d}]{Philosophy}
...
\section{Freedom}
\label{sec:org357b1d7}
\begin{frame}[label={sec:org0329e82}]{Freedom}
...
\label{sec:org641e8d6}
\begin{frame}[label={sec:org7e0e476},fragile]{Imaginary Programming}
...
\label{sec:orgeaa969a}
\subsection{Using \texttt{pen.el}}
\label{sec:orgae59775}
\begin{frame}[label={sec:org5c074b2},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgdd93a7a}
\begin{frame}[label={sec:org08cf513},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org2b33d1d}
\begin{frame}[label={sec:org16763d1},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org2af5472},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgb09e19f},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org33cb029},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgab69799}
\subsection{\texttt{pen.el}}
\label{sec:org613dd80}
\begin{frame}[label={sec:org0115b67},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgd668c82}
\begin{frame}[label={sec:org744ae3c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org0ca76bb},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgc593564}
\begin{frame}[label={sec:orgc099367}]{Something funny}
...
\begin{frame}[label={sec:org196351c}]{Something funny}
...
\begin{frame}[label={sec:orgfc606e8}]{Create a prompt}
...
\section{Appendix}
\label{sec:org6c3ef95}
\subsection{Additional reading}
\label{sec:orgc2de354}
\begin{frame}[label={sec:org4cc8363}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
