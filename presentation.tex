...
\label{sec:orgaa553c0}
\begin{frame}[label={sec:org29560b2},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org0d98bea}
\begin{frame}[label={sec:org04c18a3},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge473d1d}
\begin{frame}[label={sec:orgae16663}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org832db01}
\begin{frame}[label={sec:orgf598d9c},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org083cafb}
\begin{frame}[label={sec:org3e25990},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org48600a7}
\begin{frame}[label={sec:orgcffd7b5},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgcd65288}
\begin{frame}[label={sec:org7365bca}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgaf5435a}
\begin{frame}[label={sec:orgcc6c1ca}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org284565c}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9fe6623},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge961dc9}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8c6e6b6}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5bd1aa5}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc4e4e03}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org72731e7},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org6b09fcf}
\begin{frame}[label={sec:org68de31d},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org8b875d3}
\begin{frame}[label={sec:orge059c72},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgb64a783}
\begin{frame}[label={sec:org644e7c5}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org0ed7fbd}
\begin{frame}[label={sec:org0a87e0b},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org7090964}
\begin{frame}[label={sec:org09284c1},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orga3b009d}
\begin{frame}[label={sec:org2471ec0},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgfa55d44}
\begin{frame}[label={sec:org568bdf2},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org3385e94}
\begin{frame}[label={sec:orgee75860},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orge72fdb8}
\begin{frame}[label={sec:org35312b4},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org0c40d76}
\begin{frame}[label={sec:orgd257270},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org20a4cd2}
\begin{frame}[label={sec:orgc7801be},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd5dd209}
\begin{frame}[label={sec:org81fec10},fragile]{ilambda.el (EmacsConf 2021)}
