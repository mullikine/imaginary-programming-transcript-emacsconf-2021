...
\label{sec:org6046e08}
\begin{frame}[label={sec:org114d06f}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org7af31ac}
\begin{frame}[label={sec:orge4a5252},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org786b8b1}
\begin{frame}[label={sec:org951b857}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9d0d63c}
\begin{frame}[label={sec:orgb039785},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgd353169}
\begin{frame}[label={sec:org7958bba},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgadb5ced}
\begin{frame}[label={sec:org42ce2c2},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9eb9661}
\begin{frame}[label={sec:org28969d7}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9aef3bb}
\begin{frame}[label={sec:orgc79cec8}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0a6b164}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcc07223},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge54f3d0}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfc97792}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7cfd3fe}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org52674e6}]{Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2e44b9d}]{Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org9e9388c}
\begin{frame}[label={sec:orgcf1d550}]{Freedom (EmacsConf 2021)}
...
\label{sec:org39ef5b4}
\begin{frame}[label={sec:org8a89562},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org243b5c1}
\begin{frame}[label={sec:org0843016}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org4aa09ed}
\begin{frame}[label={sec:org5f0ba49},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org350f20d}
\begin{frame}[label={sec:org53856c8},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:org5dfea89}
\subsection{Pen.el v2}
\label{sec:orgabd56c0}
\begin{verbatim}
 1  phenomenology
