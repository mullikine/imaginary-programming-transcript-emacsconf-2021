...
\label{sec:org7c4320b}
\begin{frame}[label={sec:orgb3ace5e},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org1982bf2}
\begin{frame}[label={sec:orge5cbaf3}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4a49019}
\begin{frame}[label={sec:org2ec1454},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org4c514be}
\begin{frame}[label={sec:orgf579d51},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgc1a7d45}
\begin{frame}[label={sec:org069c0ee},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org69652ac}
\begin{frame}[label={sec:org604e136}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org1ad14f4}
\begin{frame}[label={sec:org591bf4e}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5dbf484}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge28370d},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8f7dfbf}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org87ef14f}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org750d20b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org196e881}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org88e4ebf},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org699e2c7}
\begin{frame}[label={sec:org37941c6},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org90958cc}
\begin{frame}[label={sec:orgb972c69},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:orgfa11593}
\subsection{Pen.el v2}
\label{sec:org1cd65b1}
\begin{verbatim}
 1  phenomenology
