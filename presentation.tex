...
\label{sec:orgf7f8806}
\begin{frame}[label={sec:org73059d7}]{Following along}
...
\label{sec:orgb57ca0c}
\begin{frame}[label={sec:orgdd9d06d},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org71d6863}
\begin{frame}[label={sec:org435e931}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org241dff6}
\begin{frame}[label={sec:org0eda530},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org6d4f411}
\begin{frame}[label={sec:orgc3b3007},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org8825e6d}
\begin{frame}[label={sec:orgf6e906f},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org359aa1f}
\begin{frame}[label={sec:orga960c02}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org38a29aa}
\begin{frame}[label={sec:org9fabbac}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb2aae7c}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orge72f21e},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8255605}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org42eb17f}]{Philosophy}
...
\begin{frame}[label={sec:orgb5a7525}]{Philosophy}
...
\begin{frame}[label={sec:org7967a65}]{Philosophy}
...
\begin{frame}[label={sec:orgf2cc6a1}]{Philosophy}
...
\section{Freedom}
\label{sec:org0b4163c}
\begin{frame}[label={sec:org6b1ddba}]{Freedom}
...
\label{sec:org47ad2e8}
\begin{frame}[label={sec:orgaa232dd},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgae4fb25}
\begin{frame}[label={sec:orgb69fc83}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgb3b03ea}
\begin{frame}[label={sec:org879058e},fragile]{𝑖λ (ilambda.el)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org4a4edee}
\begin{frame}[label={sec:org8bd822e},fragile]{𝑖λ (ilambda.el)}
