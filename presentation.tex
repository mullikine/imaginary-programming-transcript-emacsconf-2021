...
\label{sec:orga346ea6}
\begin{frame}[label={sec:org461d878}]{Following along}
...
\label{sec:org9d28474}
\begin{frame}[label={sec:org0ea5f93},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org622e4e9}
\begin{frame}[label={sec:orgf4d79b3}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orgc7e9052}
\begin{frame}[label={sec:orge29baff},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org83c465b}
\begin{frame}[label={sec:org2023153},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org31eb8b2}
\begin{frame}[label={sec:orgf9083dd},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgd77c88c}
\begin{frame}[label={sec:orge147114}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orga7a2550}
\begin{frame}[label={sec:orgc2f3ccf},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgdb46d07}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgdc03442}]{Philosophy}
...
\begin{frame}[label={sec:orgd85c61f}]{Philosophy}
...
\begin{frame}[label={sec:orge99f44d}]{Philosophy}
...
\begin{frame}[label={sec:orga9a2542}]{Philosophy}
...
\label{sec:org935d083}
\subsection{GPT-3}
\label{sec:org1750a86}
\begin{frame}[label={sec:org68eb389},fragile]{Text Generator}
...
\label{sec:org3ec992c}
\begin{frame}[label={sec:org0c0eee2},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org66267fa},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgd23b681}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgca3e74c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org0e5fd27}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org9d5fc47},fragile]{Design patterns}
...
\begin{frame}[label={sec:org5157766},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgda08872},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5ae7e4d},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org4cc93d5},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org1d37c7a}]{Techniques}
...
\label{sec:org678de5c}
\subsection{Using \texttt{pen.el}}
\label{sec:org2cdd343}
\begin{frame}[label={sec:org9609599},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgd00c67d}
\begin{frame}[label={sec:org752a7c8},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgb9770eb}
\begin{frame}[label={sec:orgb1fa1a2},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgad60865},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgbb7e7ee},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgbe78a72},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org7f52513}
\subsection{\texttt{pen.el}}
\label{sec:orga980ca9}
\begin{frame}[label={sec:org86013da},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org03ed4bf}
\begin{frame}[label={sec:org6c2bffe},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgd9ba83b},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org7396751}
\begin{frame}[label={sec:orgf9ff1fc}]{Something funny}
...
\begin{frame}[label={sec:org2065da4}]{Something funny}
...
\begin{frame}[label={sec:org13852cd}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgacdadbb}
\subsection{Additional reading}
\label{sec:orgeebe1cb}
\begin{frame}[label={sec:orgf10db87}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
