...
\label{sec:org9e2e34c}
\begin{frame}[label={sec:orgf474fbd},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgdd669f0}
\begin{frame}[label={sec:org180d28d},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org12f0bb3}
\begin{frame}[label={sec:orgb853c97}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org73304f9}
\begin{frame}[label={sec:org4fbb1e0},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org85cd543}
\begin{frame}[label={sec:org5141ad5},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0da6ba2}
\begin{frame}[label={sec:org4773e5c},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8b666ab}
\begin{frame}[label={sec:orgf499666}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8b59f20}
\begin{frame}[label={sec:org0c2dc12}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga531eaf}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org10a2a5a},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgbbbc437}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc8afd3d}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org27f1662}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0f59812}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org89980a3},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgdfdc87d}
\begin{frame}[label={sec:orgafdece4},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org9b60b1b}
\begin{frame}[label={sec:orgb74cae5},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org2264481}
\begin{frame}[label={sec:org159cc96}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgf0b318e}
\begin{frame}[label={sec:org0e7d92b},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgf152c04}
\begin{frame}[label={sec:orgb563ca9},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org7857145}
\begin{frame}[label={sec:orgbe10d23},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgc380346}
\begin{frame}[label={sec:orga8cba0f},fragile]{ilambda.el (EmacsConf 2021)}
