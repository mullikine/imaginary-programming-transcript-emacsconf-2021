...
\label{sec:orgbad6267}
\begin{frame}[label={sec:org8b8e99b},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org0b66b38}
\begin{frame}[label={sec:org1d45b40}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org90ffdc2}
\begin{frame}[label={sec:org229cece},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org48d489c}
\begin{frame}[label={sec:orgacb658a},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org89da8cd}
\begin{frame}[label={sec:org0e5a686},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5ee5da8}
\begin{frame}[label={sec:org6d78997}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf2c0ee9}
\begin{frame}[label={sec:orge1eec71}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org15a221a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org283085c},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9541046}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgbe005f4}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf460e25}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga503259}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgacf48b6}
\begin{frame}[label={sec:org65c0eae},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org3dc7f8e}
\begin{frame}[label={sec:orgbca808c},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:orgba08c9b}
\subsection{Pen.el v2}
\label{sec:org93625fe}
\begin{verbatim}
 1  phenomenology
