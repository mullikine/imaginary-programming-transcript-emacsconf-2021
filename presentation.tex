...
\label{sec:org59bcaf4}
\begin{frame}[label={sec:orge7d755e},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org972e4d1}
\begin{frame}[label={sec:org8ee9629},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org735bae2}
\begin{frame}[label={sec:orgbf8e09d}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org42c01ed}
\begin{frame}[label={sec:orgea99ed4},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org49ed623}
\begin{frame}[label={sec:org2c9b440},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgd76debe}
\begin{frame}[label={sec:orgcc8c70d},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org906f441}
\begin{frame}[label={sec:org488db52}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf2b02fc}
\begin{frame}[label={sec:org348dffb}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgbe40207}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga5fc8dd},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6f5f437}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5d210d1}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgcbddb7f}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org10f92c7}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org6e1dde9},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgb683eac}
\begin{frame}[label={sec:org378bac1},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org27d7e9c}
\begin{frame}[label={sec:orge4bfc0e},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org95a9383}
\begin{frame}[label={sec:org9fb944e}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org5c7f568}
\begin{frame}[label={sec:org4210617},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgfdc4758}
\begin{frame}[label={sec:orgab401c9},fragile]{ilambda.el (EmacsConf 2021)}
...
16  - "code"
17  - "expression"
18  validator: "grep -qv '(:return'"
19  examples:
20  - |-
21      (defun double-number (x)
22        (x * x))
23  - "(double-number 5)"
24  filter: on
25  completion: off
...
\begin{frame}[label={sec:org84a773f},fragile]{\texttt{imacro}}
