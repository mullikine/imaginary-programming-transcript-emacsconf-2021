...
\label{sec:org571de53}
\begin{frame}[label={sec:orgdabb500}]{Following along}
...
\label{sec:orge3434b6}
\begin{frame}[label={sec:orgf2bc46e},fragile]{Objectives}
 \begin{itemize}
...
\label{sec:org2db579f}
\subsection{Language Models is programming for AIs}
\label{sec:org7f4cdf7}
LMs are our best friends in the AI model
menagerie because they make things
intelligible -- by understanding our textual
languages.

\subsection{AI Imagination}
\label{sec:orgf6181f9}
\begin{itemize}
\item \href{https://www.youtube.com/watch?v=d-bvsJWmqlc}{Demis Hassabis: creativity and AI}
\end{itemize}

\section{Imaginary Computing}
\label{sec:orge4a375a}
\subsection{Example: AI Art described by AI}
\label{sec:org03aaa69}
...
\section{Imaginary Computing}
\label{sec:org3843c80}
\subsection{Intelligent NFTs (blockchain)}
\label{sec:org20ae91d}
...
\section{Imaginary Computing}
\label{sec:org463c4de}
\subsection{A bleak future}
\label{sec:org8dd1686}
\begin{itemize}
...
\section{Imaginary Computing}
\label{sec:orgeee812b}
\subsection{Imaginary Web}
\label{sec:orgf9c9c64}
\begin{verbatim}
...
\begin{frame}[label={sec:orga943ccc}]{Paracosm vs Metaverse}
\begin{itemize}
\item Paracosm
\begin{itemize}
\item Privacy
...
\label{sec:orga41b0ca}
\subsection{GPT-3}
\label{sec:org89836ec}
\begin{frame}[label={sec:org39a3574},fragile]{Text Generator}
...
\label{sec:org6592326}
\begin{frame}[label={sec:org168c377},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org8736cc2},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgb1acc83}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgf671d54}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org78e314c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgf3ab06d},fragile]{Design patterns}
...
\begin{frame}[label={sec:orgaa7ed68},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6ed522e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org3b1d959},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgbc4a270},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org39bda41}]{Techniques}
...
\label{sec:org5c67e91}
\subsection{Using \texttt{pen.el}}
\label{sec:org7ddb5b1}
\begin{frame}[label={sec:orgd6353a6},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgd6fa3d4}
\begin{frame}[label={sec:org63e316b},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgca2bd71}
\begin{frame}[label={sec:org117c161},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org2d88d0e},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgde2eac5},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org17a6af5},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org50ffac2}
\subsection{\texttt{pen.el}}
\label{sec:org1e24929}
\begin{frame}[label={sec:org58169b2},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org804c20c}
\begin{frame}[label={sec:orgde193d0},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgacd6729},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orga9c8f4a}
\begin{frame}[label={sec:orgd180d64}]{Something funny}
...
\begin{frame}[label={sec:orga28e27c}]{Something funny}
...
\begin{frame}[label={sec:org16ebd74}]{Create a prompt}
...
\section{Appendix}
\label{sec:orgbfab5b3}
\subsection{Additional reading}
\label{sec:orgad479c8}
\begin{frame}[label={sec:orgd7d3915}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
