...
\label{sec:org3b3f779}
\begin{frame}[label={sec:org45babf7}]{Following along}
...
\label{sec:org3ef9468}
\begin{frame}[label={sec:orge7a7358},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc6185a8}
\begin{frame}[label={sec:org88f558d}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org3ab5be4}
\begin{frame}[label={sec:orgf1417ce},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org1caeb85}
\begin{frame}[label={sec:orgae346c9},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org8cb1bee}
\begin{frame}[label={sec:orgc9fc864},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgcf4e9b4}
\begin{frame}[label={sec:org5503391}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgef3dc6c}
\begin{frame}[label={sec:orgef609da}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2f57bea}]{Imaginary Computing: Paracosm vs Metaverse}
\begin{block}{emacs}
\begin{description}
...
\begin{frame}[label={sec:org59de5ad}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1d6ff3c}]{Philosophy}
...
\begin{frame}[label={sec:org8e1d834}]{Philosophy}
...
\begin{frame}[label={sec:org23a621c}]{Philosophy}
...
\begin{frame}[label={sec:org7b2ad0d}]{Philosophy}
...
\label{sec:orgf6d6cae}
\subsection{GPT-3}
\label{sec:org2d0ad89}
\begin{frame}[label={sec:org5af01ba},fragile]{Text Generator}
...
\label{sec:org8fb5808}
\begin{frame}[label={sec:orge61ca44},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orga6c79f5},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org3103368}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7806fad}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org1056536}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org443e980},fragile]{Design patterns}
...
\begin{frame}[label={sec:org41a04b7},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org148fca6},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5c5d391},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org9c02b4e},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orga559029}]{Techniques}
...
\label{sec:orgd3b365a}
\subsection{Using \texttt{pen.el}}
\label{sec:org1bf9938}
\begin{frame}[label={sec:org94d6a9e},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgc3ea721}
\begin{frame}[label={sec:org080d836},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org84db7f6}
\begin{frame}[label={sec:orgaccf979},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org01ae807},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgc2ad566},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgfa78ccb},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org90b6495}
\subsection{\texttt{pen.el}}
\label{sec:orgef7edf6}
\begin{frame}[label={sec:orgec0add1},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgbfea9dd}
\begin{frame}[label={sec:org5efebae},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgdea6594},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org2c9b9de}
\begin{frame}[label={sec:orgba6dee7}]{Something funny}
...
\begin{frame}[label={sec:org8297416}]{Something funny}
...
\begin{frame}[label={sec:orgd22fe56}]{Create a prompt}
...
\section{Appendix}
\label{sec:org6b023b2}
\subsection{Additional reading}
\label{sec:orgaff9e26}
\begin{frame}[label={sec:org7386418}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
