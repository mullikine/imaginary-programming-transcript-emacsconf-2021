...
\label{sec:orgbf1f96b}
\begin{frame}[label={sec:org6b8ee3c}]{Following along}
...
\label{sec:orgf636b59}
\begin{frame}[label={sec:orge546e4d},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org483222e}
\begin{frame}[label={sec:orgc29f346}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org91f1fa0}
\begin{frame}[label={sec:org1727818},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org4162445}
\begin{frame}[label={sec:org407de54},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgca4b00c}
\begin{frame}[label={sec:orgd83e6fc},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org2a9cd60}
\begin{frame}[label={sec:org0d8b452}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orged38167}
\begin{frame}[label={sec:orgb32434c}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2c829f7}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org5bb8dc9},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org0321c6f}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org5fab602}]{Philosophy}
...
\begin{frame}[label={sec:orgc84d843}]{Philosophy}
...
\begin{frame}[label={sec:org18d27f3}]{Philosophy}
...
\begin{frame}[label={sec:orgbf1da3d}]{Philosophy}
...
\section{Freedom}
\label{sec:org68d4db2}
\begin{frame}[label={sec:org948930d}]{Freedom}
...
\label{sec:org9c80a13}
\begin{frame}[label={sec:org77a79e8},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:org7efd357}
\begin{frame}[label={sec:orgefbff1b}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org60e1c73}
\begin{frame}[label={sec:org2ea3719},fragile]{𝑖λ (ilambda.el)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:orgdf68ff1}
\begin{frame}[label={sec:orgc367b98},fragile]{𝑖λ (ilambda.el)}
