...
\label{sec:org051e186}
\begin{frame}[label={sec:orgc0e3a6e}]{Following along}
...
\label{sec:org5d7b185}
\begin{frame}[label={sec:org5084e1c},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org5ca36d6}
\begin{frame}[label={sec:orgcd93414}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org3fc9d84}
\begin{frame}[label={sec:org63cb9aa},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org32cdf85}
\begin{frame}[label={sec:orga323ffc},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgcfa0629}
\begin{frame}[label={sec:org481d153},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org9b0cb9b}
\begin{frame}[label={sec:org7d9cc2d}]{Imaginary Computing: Potential Dystopia}
