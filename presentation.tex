...
\label{sec:org02d8831}
\begin{frame}[label={sec:org714b1bc},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org8906a56}
\begin{frame}[label={sec:org40d63e9},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgdfabeb0}
\begin{frame}[label={sec:org155f9ca}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org44c4f10}
\begin{frame}[label={sec:org57c6b73},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org22cb13c}
\begin{frame}[label={sec:org9033105},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgaca7d46}
\begin{frame}[label={sec:orgcc909f3},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org55b2271}
\begin{frame}[label={sec:org7474115}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8311812}
\begin{frame}[label={sec:org559a454}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd912367}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfd49837},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0ce5090}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org5e028c5}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgde5f90a}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgdbaf574}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org693f02c},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org20859df}
\begin{frame}[label={sec:org30af520},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orged1904c}
\begin{frame}[label={sec:org5d5aa8c},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd5f2439}
\begin{frame}[label={sec:orgce77559}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org59210c0}
\begin{frame}[label={sec:org8308cd3},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org1a509e0}
\begin{frame}[label={sec:orga5ee725},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org2dd9829}
\begin{frame}[label={sec:org16fd8e1},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orga2a2812}
\begin{frame}[label={sec:org22b0f3f},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgdefed41}
\begin{frame}[label={sec:orgc0b80f3},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgd990c22}
\begin{frame}[label={sec:org8a62227},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgbdb6513}
\begin{frame}[label={sec:orga6e1836},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org796c6f2}
\begin{frame}[label={sec:org5039ae1},fragile]{ilambda.el (EmacsConf 2021)}
