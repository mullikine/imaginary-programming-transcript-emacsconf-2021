...
\label{sec:orga380bf5}
\begin{frame}[label={sec:org9ed280f}]{Following along}
...
\label{sec:orgd2a47d5}
\begin{frame}[label={sec:org9e45fd2},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgbb31809}
\begin{frame}[label={sec:org1c01638}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org7da6d24}
\begin{frame}[label={sec:org3ab62e9},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:orgcd0e50e}
\begin{frame}[label={sec:orga79b9c1},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org17b0373}
\begin{frame}[label={sec:orgc370bab},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orge6dbca4}
\begin{frame}[label={sec:org40ec7bb}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orga45f3c1}
\begin{frame}[label={sec:org7a7e679},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org7a18ed2}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org1094d0c}]{Philosophy}
...
\begin{frame}[label={sec:org38a3eb8}]{Philosophy}
...
\begin{frame}[label={sec:org9329363}]{Philosophy}
...
\begin{frame}[label={sec:org14707a7}]{Philosophy}
...
\label{sec:orgff73465}
\subsection{GPT-3}
\label{sec:org8df6e52}
\begin{frame}[label={sec:orgd461ceb},fragile]{Text Generator}
...
\label{sec:orgbe02229}
\begin{frame}[label={sec:org9a6055b},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org8c5e598},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org1f39ae1}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org713e83c}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3237b8e}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org63a3a54},fragile]{Design patterns}
...
\begin{frame}[label={sec:org785d6ad},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgdf71acf},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org9dc10bf},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org34b12d7},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org5c715a3}]{Techniques}
...
\label{sec:org20a52d1}
\subsection{Using \texttt{pen.el}}
\label{sec:org6b957a6}
\begin{frame}[label={sec:orgc52e94f},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orga501368}
\begin{frame}[label={sec:org1d5bc21},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgd2c3b4d}
\begin{frame}[label={sec:orgd485c3f},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orga5e8bba},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:orgbd71d45},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgee9106e},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:org9881692}
\subsection{\texttt{pen.el}}
\label{sec:orgef070ae}
\begin{frame}[label={sec:org00ac0e3},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org826e216}
\begin{frame}[label={sec:orgf8d4a13},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orgf353a40},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgc0c610d}
\begin{frame}[label={sec:org22ebfb6}]{Something funny}
...
\begin{frame}[label={sec:org7edaf60}]{Something funny}
...
\begin{frame}[label={sec:org267f0db}]{Create a prompt}
...
\section{Appendix}
\label{sec:org41bd7ac}
\subsection{Additional reading}
\label{sec:org7e6067f}
\begin{frame}[label={sec:org779bc0b}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
