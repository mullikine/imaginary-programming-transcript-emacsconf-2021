...
\label{sec:org0ecec86}
\begin{frame}[label={sec:org8f06026},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgba92dd5}
\begin{frame}[label={sec:org6a0949a},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgc2be4bb}
\begin{frame}[label={sec:orga7ec464}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org252b980}
\begin{frame}[label={sec:org8028dd4},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org88b181d}
\begin{frame}[label={sec:org756975b},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5ba95ec}
\begin{frame}[label={sec:org0bf37ad},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8661a86}
\begin{frame}[label={sec:orgdfa7eca}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org078e841}
\begin{frame}[label={sec:org9b4410e}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf843e30}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfe0e522},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0fc92e1}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org615709f}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge6eeb26}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orga25f1b9}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc130730},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org20f19a9}
\begin{frame}[label={sec:org5030a3f},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgfbcb483}
\begin{frame}[label={sec:org1c17c68},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgf7314d7}
\begin{frame}[label={sec:org801a0d0}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgc535bd7}
\begin{frame}[label={sec:org357e0c3},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org1ae1565}
\begin{frame}[label={sec:orgeabefa1},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org1383cfe}
\begin{frame}[label={sec:org75fd6f0},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org6c441b7}
\begin{frame}[label={sec:org5f51c0f},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org8135f4a}
\begin{frame}[label={sec:org0fe8987},fragile]{ilambda.el (EmacsConf 2021)}
