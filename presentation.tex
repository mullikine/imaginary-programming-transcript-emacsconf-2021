...
\label{sec:orgcd3b22c}
\begin{frame}[label={sec:orge676ce1}]{Following along}
...
\label{sec:org05eaf0f}
\begin{frame}[label={sec:orgad75ed1},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\label{sec:org4936e0d}
\begin{frame}[label={sec:orgd557272}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org3c68e19}
\begin{frame}[label={sec:org9fa72f6},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org0916051}
\begin{frame}[label={sec:org25c1cef},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:orgb28d203}
\begin{frame}[label={sec:org9d3633d},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org13d72b3}
\begin{frame}[label={sec:orge2d5d14},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb5ea96f}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgdb8a48b},fragile]{Philosophy}
...
\label{sec:org3dc9a15}
\subsection{GPT-3}
\label{sec:orgfd63910}
\begin{frame}[label={sec:org11b02b2},fragile]{Text Generator}
...
\label{sec:org6b85f06}
\begin{frame}[label={sec:org67e1b41},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:orgf074d58},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:orgba15f21}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgc7bbcbf}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:orgadc4010}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7b75b54},fragile]{Design patterns}
...
\begin{frame}[label={sec:org13c69e6},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orga6511cc},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org6a2d0f8},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgcf280a8},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:orgb48a067}]{Techniques}
...
\label{sec:org66147a9}
\subsection{Using \texttt{pen.el}}
\label{sec:org9721afc}
\begin{frame}[label={sec:orga0e35ba},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgf955128}
\begin{frame}[label={sec:org19848da},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orge80d3a8}
\begin{frame}[label={sec:org8360c67},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org164cc17},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org25f32c9},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:orgd3c7c09},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgd8343a2}
\subsection{\texttt{pen.el}}
\label{sec:org252a637}
\begin{frame}[label={sec:org5d1759c},fragile]{\texttt{Prompts as functions}}
...
\label{sec:org7f3ede0}
\begin{frame}[label={sec:orgf6c9eef},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:org32ab11c},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:org8d929ee}
\begin{frame}[label={sec:org74e5e9c}]{Something funny}
...
\begin{frame}[label={sec:orgf58cced}]{Something funny}
...
\begin{frame}[label={sec:org59afcaa}]{Create a prompt}
...
\section{Appendix}
\label{sec:org409c09d}
\subsection{Additional reading}
\label{sec:org8d5ba23}
\begin{frame}[label={sec:orga3f2b69}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
