...
\label{sec:org2efcc42}
\begin{frame}[label={sec:org3c97761},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgceff726}
\begin{frame}[label={sec:org6897eaa},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org2664332}
\begin{frame}[label={sec:org24c0aca}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgcf6b61c}
\begin{frame}[label={sec:org8f768c3},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9c2b5d6}
\begin{frame}[label={sec:org498abfd},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\begin{frame}[label={sec:org96f1cf5},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgd2c3ee3}
\begin{frame}[label={sec:org63675af}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8397944}
\begin{frame}[label={sec:org58a120a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org527b092}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org54351ae},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org93ceffc}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9194160}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org69ae9b1}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org1de0b9d}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org09eedea},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgfe18d18}
\begin{frame}[label={sec:org081b266},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org81acfc3}
\begin{frame}[label={sec:org4e16a86},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgca3fd4c}
\begin{frame}[label={sec:orgb260dc0}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgf078858}
\begin{frame}[label={sec:orge136bbd},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org2ebb98e}
\begin{frame}[label={sec:org45cd03e},fragile]{ilambda.el (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0c5c77e},fragile]{\texttt{imacro}}
 {\tiny
