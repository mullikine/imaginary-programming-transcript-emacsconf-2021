...
\begin{frame}[label={sec:org82f9efa}]{Following along}
...
\label{sec:orgc651f0e}
\begin{frame}[label={sec:orgff83b01},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgeb6ecc2}
\begin{frame}[label={sec:orgbe7d39d}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:orgcd747d2}
\begin{frame}[label={sec:org4e669fc},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org1e69fbe}
\begin{frame}[label={sec:orgf68190f},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org9e60768}
\begin{frame}[label={sec:orgd84dfd7},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org5e2fe3e}
\begin{frame}[label={sec:org9bcb2dc}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:orgf79d86c}
\begin{frame}[label={sec:orgfa10e26}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org39c6c51}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org2e1d098}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgdae6faa}]{Philosophy}
...
\begin{frame}[label={sec:org01d5dbc}]{Philosophy}
...
\begin{frame}[label={sec:orgc8e159f}]{Philosophy}
...
\begin{frame}[label={sec:orgffd007e}]{Philosophy}
...
\section{Freedom}
\label{sec:org1358a46}
\begin{frame}[label={sec:org18f6a29}]{Freedom}
...
\label{sec:org725bffe}
\begin{frame}[label={sec:org1f89e47},fragile]{Imaginary Programming}
...
{\tiny
\begin{verbatim}
"\"[((name . \\\"guix\\\") (description .
\\\"The GNU package manager\\\") (updated_at .
\\\"2014-04-21T18:49:59Z\\\") (created_at .
\\\"2014-04-21T18:49:59Z\\\") (pushed_at .
\\\"2014-04-21T18:49:59Z\\\")) ((name .
\\\"guix-patches\\\") (description .
\\\"Packages from the GNU guix package
manager\\\") (updated_at .
\\\"2014-04-21T18:49:59Z\\\") (created_at .
\\\"2014-04-21T18:49:59Z\\\") (pushed_at .
\\\"2014-04-21T18:49:59Z\\\")) ((name .
\\\"guix-patches-all\\\") (description .
\\\"Packages from the GNU guix package
manager\\\") (updated_at .
\\\"2014-04-21T18:49:59\""
\end{verbatim}
...
\label{sec:org196be13}
\subsection{Using \texttt{pen.el}}
\label{sec:orgbb90e70}
\begin{frame}[label={sec:org3591a20},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org1cad9f6}
\begin{frame}[label={sec:orgc6eb991},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org2dd75a6}
\begin{frame}[label={sec:org5f6e08c},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:orgc61c175},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org4138b97},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org8a9128f},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orge970f36}
\subsection{\texttt{pen.el}}
\label{sec:org7040288}
\begin{frame}[label={sec:org387c545},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgb5b7a5b}
\begin{frame}[label={sec:org0f2697c},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orge2176e9},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgcf25571}
\begin{frame}[label={sec:org1fe9072}]{Something funny}
...
\begin{frame}[label={sec:orgfb69dc5}]{Something funny}
...
\begin{frame}[label={sec:org30a7bec}]{Create a prompt}
...
\section{Appendix}
\label{sec:org9bcdf8c}
\subsection{Additional reading}
\label{sec:org4258462}
\begin{frame}[label={sec:org26a2ab4}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
