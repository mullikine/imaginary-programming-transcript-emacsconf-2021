...
\subsection{GPT-3}
\label{sec:orge27fd80}
\begin{frame}[label={sec:org66d31f4},fragile]{Text Generator}
...
\label{sec:orgd2fb81d}
\begin{frame}[label={sec:orga216bba},fragile]{Prompt Engineering}
...
\begin{frame}[label={sec:org69b7c1f},fragile]{Some prompts I've made}
...
\begin{frame}[label={sec:org575eca7}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org349bc2b}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org3ed0b48}]{Tasks suitable for GPT-3}
...
\begin{frame}[label={sec:org7a6d212},fragile]{Design patterns}
...
\begin{frame}[label={sec:org22712a1},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org11f813b},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org9090b19},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org305b78d},fragile]{Design patterns}
 Taken from Prompt Design 101.
...
\begin{frame}[label={sec:org2f08bc6}]{Techniques}
...
\label{sec:org0d90b9b}
\subsection{Using \texttt{pen.el}}
\label{sec:orgafaf77a}
\begin{frame}[label={sec:org1914fcb},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:org993ebaa}
\begin{frame}[label={sec:org94c3cbf},fragile]{\texttt{pen.el}}
...
\subsection{Using \texttt{pen.el}}
\label{sec:orgd76c2fb}
\begin{frame}[label={sec:org701a58b},fragile]{\texttt{pen.el}}
...
\begin{frame}[label={sec:org7f29663},fragile]{Prompt YAML format Part 1}
...
\begin{frame}[label={sec:org3e05b1f},fragile]{Prompt YAML format Part 2}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  top-p: 1
...
\begin{frame}[label={sec:org0f1479b},fragile]{Prompt YAML format: Part 3}
 \begin{block}{\texttt{meeting-bullets-to-summary.prompt}}
\begin{verbatim}
1  vars:
2  - "notes"
...
\label{sec:orgfd42a0e}
\subsection{\texttt{pen.el}}
\label{sec:org8750a1f}
\begin{frame}[label={sec:org586c191},fragile]{\texttt{Prompts as functions}}
...
\label{sec:orgcad1bc7}
\begin{frame}[label={sec:orgf2e9c00},fragile]{\texttt{examplary}: examples as functions}
...
\begin{frame}[label={sec:orga895d52},fragile]{\texttt{examplary}: examples as functions}
 \begin{block}{Analogy}
{\footnotesize
\begin{verbatim}
 1  (def analogy
...
\label{sec:orgff2bdd5}
\begin{frame}[label={sec:orgdeb5367}]{Something funny}
...
\begin{frame}[label={sec:orga229306}]{Something funny}
...
\begin{frame}[label={sec:org183f8e2}]{Create a prompt}
...
\section{Appendix}
\label{sec:org32c913c}
\subsection{Additional reading}
\label{sec:orgbc86ccc}
\begin{frame}[label={sec:org07a4496}]{Tutorials}
\begin{block}{Ruby}
{\footnotesize
