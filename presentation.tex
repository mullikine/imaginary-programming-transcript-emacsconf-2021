...
\label{sec:orgf3628c7}
\begin{frame}[label={sec:orgebf755b},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orge91e1d4}
\begin{frame}[label={sec:org3460a30},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org8e0ee8c}
\begin{frame}[label={sec:org13ebed7}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org675c54b}
\begin{frame}[label={sec:org7a3ae36},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8b62d8e}
\begin{frame}[label={sec:org80c1c37},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org3cdbfe9}
\begin{frame}[label={sec:orgb22bd20},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org0aae2e8}
\begin{frame}[label={sec:org6cee73a}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf6898f6}
\begin{frame}[label={sec:orgac004ba}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org076972b}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb7ec660},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7ffd8b1}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge685cf9}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgeac6174}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org017fad5}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgd4135a0},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgfdc0b8c}
\begin{frame}[label={sec:orgcb16b94},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org620f409}
\begin{frame}[label={sec:orgfd48f40},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgb855202}
\begin{frame}[label={sec:org04fcb3a}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgeadc0b3}
\begin{frame}[label={sec:org9bc3be9},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
