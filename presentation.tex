...
\label{sec:org5d67a81}
\begin{frame}[label={sec:org4fa18e2}]{Following along}
...
\label{sec:org1e6148d}
\begin{frame}[label={sec:org7a75f56},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orga905c47}
\begin{frame}[label={sec:orgdb188c6}]{Imaginary Computing: AI Imagination}
...
\section{Imaginary Computing}
\label{sec:org01e446a}
\begin{frame}[label={sec:org9d70c12},fragile]{Imaginary Computing: Emacs as the shell}
...
\section{Imaginary Computing}
\label{sec:org1930beb}
\begin{frame}[label={sec:org98405a4},fragile]{Imaginary Computing: Blockchain}
...
\section{Imaginary Computing}
\label{sec:org7243c04}
\begin{frame}[label={sec:orgaf08889},fragile]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org383f8e9}
\begin{frame}[label={sec:orgedd28c6}]{Imaginary Computing: Potential Dystopia}
...
\section{Imaginary Computing}
\label{sec:org74eb43d}
\begin{frame}[label={sec:orgd7f4f4f}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org46870d3}]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgcd72c32},fragile]{Imaginary Computing: Paracosm vs Metaverse}
...
\begin{frame}[label={sec:org8c830a5}]{Paracosm vs Metaverse}
...
\begin{frame}[label={sec:orgb0b0bc8}]{Philosophy}
...
\begin{frame}[label={sec:org012423c}]{Philosophy}
...
\begin{frame}[label={sec:org4ed3f05}]{Philosophy}
...
\begin{frame}[label={sec:orgf929ca5}]{Philosophy}
...
\section{Freedom}
\label{sec:org03c5ff2}
\begin{frame}[label={sec:org1ed926c}]{Freedom}
{\tiny
...
\item they can see anything public (they are license-blinded),
...
\label{sec:org9896608}
\begin{frame}[label={sec:orge58d48e},fragile]{Imaginary Programming}
...
\section{ilambda}
\label{sec:orgae71608}
\begin{frame}[label={sec:org55abcb4}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orge9c6157}
\begin{frame}[label={sec:org6f9e30c},fragile]{ilambda.el}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org2fad53d}
\begin{frame}[label={sec:org95af633},fragile]{ilambda.el}
