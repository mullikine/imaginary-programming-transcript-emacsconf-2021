...
\label{sec:org1052d0e}
\begin{frame}[label={sec:org34af08c},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgdbcce4f}
\begin{frame}[label={sec:org9e00297},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orgf20a9eb}
\begin{frame}[label={sec:orgde50869}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org225e850}
\begin{frame}[label={sec:orgc2a3c38},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org759ae5c}
\begin{frame}[label={sec:org0e51cf0},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgbfa5a75}
\begin{frame}[label={sec:org2ec31f3},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org90668e0}
\begin{frame}[label={sec:org860ddd3}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org9ef4b9d}
\begin{frame}[label={sec:orgd3a4e5a}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8a67134}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org8cd399b},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org7382cac}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgf319050}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgc19908b}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgdce2e14}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9299df4},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org998b722}
\begin{frame}[label={sec:org3ce65f1},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:org4d254d9}
\begin{frame}[label={sec:orga5b7a1c},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org9c17f80}
\begin{frame}[label={sec:org5569783}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org0018fdd}
\begin{frame}[label={sec:orgc7924db},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org64d0490}
\begin{frame}[label={sec:orgedd89b8},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{\texttt{ieval}}
{\tiny
\texttt{ieval} will imagine the result of evaluating its body.
}
...
\begin{frame}[label={sec:orgd62fa90},fragile]{\texttt{imacro}}
 {\tiny
