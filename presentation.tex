...
\label{sec:orgcc3a319}
\begin{frame}[label={sec:org7abf59e},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:orga551887}
\begin{frame}[label={sec:org72a5c5b},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org9ce76db}
\begin{frame}[label={sec:org19fe12f}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org520627d}
\begin{frame}[label={sec:orgd5ba298},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org5914013}
\begin{frame}[label={sec:org6e1503b},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgca9dbeb}
\begin{frame}[label={sec:org979dfd6},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orgf498516}
\begin{frame}[label={sec:orgd5a82c0}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org99faf19}
\begin{frame}[label={sec:org203b833}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org2e217da}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb110f8f},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orge8d4de8}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4802d89}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org4482a48}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgb707132}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgbfe9fd2},fragile]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:org13b64e2}
\begin{frame}[label={sec:org6c3d99b},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgb56a945}
\begin{frame}[label={sec:org563775e},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orga1ab2e8}
\begin{frame}[label={sec:orgb142c0a}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:org5edc599}
\begin{frame}[label={sec:org73ef7cf},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org68bd5ca}
\begin{frame}[label={sec:org10efa32},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org2289fc2}
\begin{frame}[label={sec:org01cfad0},fragile]{ilambda.el (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:orgccfe5c9}
\begin{frame}[label={sec:org8c04ecd},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{\texttt{ilambda} \texttt{explanation}}
\texttt{ilambda} is useful primitive of the
...
\begin{frame}[label={sec:orge9b246f},fragile]{\texttt{imacro} generates code}
 {\tiny
