...
\label{sec:orgf3a072b}
\begin{frame}[label={sec:org17b6361}]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org48f6923}
\begin{frame}[label={sec:orga585598},fragile]{Imaginary Programming (IP) (EmacsConf 2021)}
...
\label{sec:org47001d9}
\begin{frame}[label={sec:orgeadfd83}]{Imaginary Computing: AI Imagination (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:orga902c4e}
\begin{frame}[label={sec:orge080646},fragile]{Imaginary Computing: Emacs as the shell (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org7666017}
\begin{frame}[label={sec:orgf9603ec},fragile]{Imaginary Computing: Blockchain (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org231ab35}
\begin{frame}[label={sec:orgb90f462},fragile]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org8f14872}
\begin{frame}[label={sec:org102ba18}]{Imaginary Computing: Potential Dystopia (EmacsConf 2021)}
...
\section{Imaginary Computing}
\label{sec:org42a21c7}
\begin{frame}[label={sec:org7eeeb43}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org655949c}]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org9fa5b7d},fragile]{Imaginary Computing: Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgec87b34}]{Paracosm vs Metaverse (EmacsConf 2021)}
...
\begin{frame}[label={sec:org29d786f}]{Imaginary Programming (IP)Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org0990b85}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:org630a0ae}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\begin{frame}[label={sec:orgfd4b816}]{Imaginary Computing (IC) Philosophy (EmacsConf 2021)}
...
\section{Freedom}
\label{sec:orgbfba4fc}
\begin{frame}[label={sec:org4d2e2d2},fragile]{Imaginary Computing (IC) Freedom (EmacsConf 2021)}
...
\label{sec:orgee2a4aa}
\begin{frame}[label={sec:org0e984a8},fragile]{Imaginary Programming (EmacsConf 2021)}
...
\section{ilambda}
\label{sec:org22a89b9}
\begin{frame}[label={sec:orge0eb3dc}]{Blockchain and a Language model is all you need}
...
\section{ilambda}
\label{sec:orgf7e9275}
\begin{frame}[label={sec:orgb090cf9},fragile]{ilambda.el (EmacsConf 2021)}
 \begin{block}{Code}
...
\section{ilambda}
\label{sec:org48bc12b}
\begin{frame}[label={sec:org45ea65e},fragile]{ilambda.el (EmacsConf 2021)}
...
\label{sec:orgc02209f}
\subsection{Pen.el v2}
\label{sec:org0310c25}
\begin{verbatim}
 1  phenomenology
