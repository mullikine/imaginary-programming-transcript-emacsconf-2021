...
This is what you get when you combine GPT-3, or free-as-in-freedom models such as GPT-3 with programming.

=reversible programming= is another paradigm I think also become more mainstream.
