...
It's not a conventional programming paradigm yet, but I think programming with LMs is going to quickly become an intrinsic part of normal
programming, I think, due to recent advances in the capabilities of language models such as GPT-3.

# along with =reversible programming=, 
...
- within the comfort of emacs lisp:
