...
mainstream very soon -- perhaps within a year,
since people who understand the way GitHub's
Copilot works will be quickly dissatisfied
with the limiting and opaque functions that it
provides. We are engineers, not consumers.
...
Imaginary programming is what you get when you
