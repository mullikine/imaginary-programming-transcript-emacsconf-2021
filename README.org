...
to programming, however, and you would want to
be programming in this style if you want to, for example:
...
- utilise the language you understand in order to frame complicated or intractable problems as tasks for the AI to implement instead of yourself
