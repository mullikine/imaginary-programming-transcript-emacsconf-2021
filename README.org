...
* Transcript
Dear Emacs users, thank you for listening to
my talk on Imaginary Programming.

The goal of this talk is to introduce people
to a style of programming which I call =Imaginary Programming=.

It may be classed as an unconventional
programming paradigm in the same vein as =Reversible Computing=.

However, I would like to stress that this is
an emerging style, which I think will become
an intrinsic part of normal programming.

who are unfamiliar with recent advances in LMs
