...
However, programming with LMs is rapidly
emerging as an intrinsic part of normal
programming and to call this unconventional is
a mistake, I think, similarly to how it would
be a mistake to dismiss imaginary numbers,
fractions or negative numbers as being
conventional.
